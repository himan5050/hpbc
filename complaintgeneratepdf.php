...
if($_REQUEST['op'] == 'complaintreport'){
...
<tr><td class="header_report" style="text-align:center;" align="center" colspan="14">RTI Filed, Section Wise, Zone Wise</td></tr></table><br />';
...
<tr><td class="header1" align="left"><b>District Name : </b>'.ucwords(all).'</td></tr>
	...
	if($type_complaint){
		...
		$header2 .='<table cellpadding="0" cellspacing="0" border="0">
<tr><td class="header1" align="left"><b>Complaint Type : </b>'.getLookupName(ucwords($type_complaint)).'</td></tr>
</table><br />';
	}
	...
	if($type_complaint == ''){
		$cond .= " ";
		$header2 .='<table cellpadding="0" cellspacing="0" border="0">
<tr><td class="header1" align="left"><b>Complaint Type : </b>'.ucwords(all).'</td></tr>
</table><br />';
	}
...
<td width="18%" colspan="1" align="left" class="header2">Section</td>
<td width="20%" colspan="1" align="left" class="header2">District</td>
<td width="22%" colspan="1" align="left" class="header2">Complaint Type</td>
<td width="15%" colspan="1" align="left" class="header2">No. of Complaint</td>
 ...
 while($rs = db_fetch_object($res)){
  $sd= date('d-m-Y',strtotime($rs->datecurrent));
   ...
   if($counter%2==0){ $class='header4_1';}else{$class='header4_2';}
				...
				<td  class="'.$class.'" align="left">'.ucwords(getLookupName($rs->section)).'</td>
				<td  class="'.$class.'" align="left">'.ucwords(getdistrict($rs->district_id)).'</td>
				<td  class="'.$class.'" align="left">'.getLookupName($rs->type_complaint).'</td>
				<td  class="'.$class.'" align="right">'.$rs->no.'</td>
