...
$output .='<tr><td class="header_first" align="left">
<b>Scheme Name: </b>'.ucwords(getSchemeName($schemename)).'</td></tr>';
...
if($headtype_id==248){$stuff7=$stuff3->schemeName_name;} else {$stuff7=$stuff3->lookup_name;}
   ...
   if($counter%2==0){ $class='header4_1';}else{$class='header4_2';}
				...
				<td width="8%" class="'.$class.'" align="right">'.$allocated.'</td>
				<td width="8%" class="'.$class.'" align="right">'.$consumed.'</td>
				<td width="8%" class="'.$class.'" align="right">'.$bal.'</td>
				</tr>';
				$counter++;
 }
