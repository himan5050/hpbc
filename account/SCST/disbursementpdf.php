...
<tr><td class="header_report" align="center">Disbursement Report</td></tr></table><br />';
...
//header close
  ...
  $sql = "SELECT tbl_scheme_master.scheme_name,tbl_loan_detail.reg_number,tbl_loanee_detail.account_id,tbl_loanee_detail.fname,tbl_loanee_detail.lname,tbl_loanee_detail.loanee_id,tbl_loanee_detail.district,
	tbl_loanee_detail.tehsil,tbl_loanee_detail.address1,tbl_loanee_detail.address2,tbl_loan_detail.loan_requirement,tbl_loan_disbursement.createdon,tbl_loan_disbursement.cheque_number,tbl_loan_disbursement.amount
...
$header3 .='<table cellpadding="3" cellspacing="2" border="0" class="tbl_border" align="center"><tr>
...
where 1=1";
 ...
 while($rs = db_fetch_object($res)){
	 ...
	 $balance_amount=$ending_balance-$dis_amount;
				...
				<td width="8%" class="'.$class.'" align="right">'.$wer.'</td>
				<td width="8%" class="'.$class.'" align="right">'.$dis_amount.'</td>
				<td width="8%" class="'.$class.'" align="right">'.$rs->cheque_number.'</td>
				<td width="8%" class="'.$class.'" align="right">'.round($balance_amount,2).'</td>
