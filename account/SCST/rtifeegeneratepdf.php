...
<td width="8%" colspan="1" align="left" class="header2">Mode of Fee</td>
<td width="8%" colspan="1" align="left" class="header2">Amount</td>
<td width="8%" colspan="1" align="left" class="header2">Date</td>
<td width="8%" colspan="1" align="left" class="header2">IPO No.</td>
</tr>';
...
$sumamount =$sqlqu->sumamount;
   ...
   if ($rs->mode_payment == 'ipo'){ $pmode = 'IPO';}
				...
				<td width="8%" class="'.$class.'" align="left">'.ucwords($pmode).'</td>
				<td width="8%" class="'.$class.'" align="right">'.number_format($amount, 2,'.',' ').'</td>
				<td width="8%" class="'.$class.'" align="center">'.date('d-m-Y',strtotime($date)).'</td>
				<td width="8%" class="'.$class.'" align="right">'.$ipono.'</td>
				';
				$output .='</tr>';
				$counter++; 
...
$outputt .='</table>';
 $outputtt .='<tr class="odd"><td width="6%"><strong>Total Amount</strong></td><td>'.number_format($sumamount, 2,'.',' ').'</td></tr>';
