...
$output .= '<table>
 ...
 while($rs = db_fetch_object($res)){
   ...
   if($counter%2==0){ $class='header4_1';}else{$class='header4_2';}
			...
			$output .='<td class="'.$class.'" align="right">'.$rs->starting_balance.'</td>';
			$output .='<td class="'.$class.'" align="right">'.$rs->other_charges_paid.'</td>';
			$output .='<td class="'.$class.'" align="right">'.$rs->LD_paid.'</td>';
			$output .='<td class="'.$class.'" align="right">'.$rs->interest_paid.'</td>';
			$output .='<td class="'.$class.'" align="right">'.$rs->principal_paid.'</td>';
			$output .='<td class="'.$class.'" align="right">'.$rs->ending_balance.'</td>';
			$output .='<td class="'.$class.'" align="right">'.$rs->installment_paid.'</td>
