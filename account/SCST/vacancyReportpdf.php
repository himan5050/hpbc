...
<td  colspan="1" align="left" class="header2">Vacancy Title</td>
<td colspan="1" align="left" class="header2">Description</td>
<td  colspan="1" align="left" class="header2">Pay Detail</td>
<td  colspan="1" align="left" class="header2">Starting From</td>
<td  colspan="1" align="left" class="header2">Last Date of Application</td>

<td colspan="1" align="left" class="header2">Status</td>
...
//$assigned_to=db_fetch_object($assign);
   ...
   if($counter%2==0){ $class='header4_2';}else{$class='header4_1';}
				...
				<td class="'.$class.'" align="left">'.ucwords($rs->vacancy_title).'</td>
