...
Class Journal {
	...
	function Add_To_GLAnalysis($Amount, $Narrative, $GLCode, $GLActName, $tag, $preparedby, $approvedby,$voucherno, $assetid=1){
		if (isset($GLCode) AND $Amount!=0){
			$this->GLEntries[$this->GLItemID] = new JournalGLAnalysis($Amount, $Narrative, $this->GLItemID, $GLCode, $GLActName, $tag, $preparedby, $approvedby, $voucherno, $assetid);
			$this->GLItemCounter++;
			$this->GLItemID++;
...
Class JournalGLAnalysis {
	...
	function JournalGLAnalysis ($Amt, $Narr, $id, $GLCode, $GLActName, $tag,$preparedby, $approvedby, $voucherno, $assetid){
