...
echo '<div class="breadcrumb"><a href="/'.$u[1].'">Home</a> &raquo; <a href="'. $_SERVER['SCRIPT_NAME'].'">Condemnation</a></div>';
...
if (isset($_POST['submit']) ){
  $InputError = 0;
	  ...
	  $disdate=$_POST['JournalProcessDate'];
     // $purdate=$_POST['element_2_2']."-".$_POST['element_2_1']."-".$_POST['element_2_3'];
	 $purdate=$_POST['JournalProcessDate1'];
 ...
 <tr class="evenrow">
   <td colspan="2"> <div class="left">Date: <span style="color:#FF0000">*</span></div>
    <div class="right"><!--<div id="li_1" style="width:353px;" >
		...
		</div></div>--><div  id="date"><input type="text" id="JournalProcessDate" name="JournalProcessDate" class="date" alt="<?php echo $_SESSION['DefaultDateFormat'];?>" maxlength=10 size=11 onChange="isDate(this, this.value, '<?php echo $_SESSION['DefaultDateFormat'];?>')" value="<?php echo $_POST['JournalProcessDate'];?>"></div></div></td>
  </tr>
  
  <tr class="oddrow">
    <td colspan="2"> <div class="left">Name of officer to be contacted: <span style="color:#FF0000">*</span></div>
    <div class="right"><input type="text" name="officername" id="officername"  size="45" maxlength="45" value="<?php echo $_POST['officername'];?>"onkeypress="return alphanumeric(event)"  ></div></td>
  </tr>
  <tr class="evenrow">
...
?>
  ...
  <tr class="oddrow">
    ...
    <div class="right"><input type="text" name="own_authority" id="own_authority" size="45" maxlength="45"  value="<?php echo $_POST['own_authority'];?>" onkeypress="return alphanumeric(event)"  ></div></td>
  </tr>


    <tr class="evenrow"> <td colspan="2"> <div class="left">S. No.: <span style="color:#FF0000">*</span></div> <div class="right"><input type="text" name="sr_no" id="sr_no" size="45" maxlength="10" value="<?php echo $_POST['sr_no']?>" onkeypress = "return fononlyn(event)" /></div></td></tr>
    <tr class="oddrow"><td colspan="2"> <div class="left">Item Code: <span style="color:#FF0000">*</span></div><div class="right"><select name="code" id="code"><option value="">--Select Item--</option>
    <?php
	...
	<tr class="evenrow"><td colspan="2"> <div class="left">Particulars of store items: <span style="color:#FF0000">*</span></div><div class="right"><input type="text" name="particulars" id="particulars" size="45" maxlength="45" value="<?php echo $_POST['particulars']?>"onkeypress="return alphanumeric(event)" /></div></td></tr>
	<tr class="oddrow"><td colspan="2"> <div class="left">Quantity: <span style="color:#FF0000">*</span></div><div class="right"><input type="text" name="quantity" id="quantity"  size="45" maxlength="10" value="<?php echo $_POST['quantity']?>" onkeypress = "return fononlyn(event)" /></div></td></tr>
	<tr class="evenrow"><td colspan="2"> <div class="left">Weight: <span style="color:#FF0000">*</span></div> <div class="right"><input type="text" name="weight" id="weight" size="45" maxlength="11" value="<?php echo $_POST['weight']?>" class="number" /></div></tr>
	...
	<span>
		...
		</div></div>--><div  id="date"><input type="text" id="JournalProcessDate1" name="JournalProcessDate1" class="date" alt="<?php echo $_SESSION['DefaultDateFormat'];?>" maxlength=10 size=11 onChange="isDate(this, this.value, '<?php echo $_SESSION['DefaultDateFormat1'];?>')" value="<?php echo $_POST['JournalProcessDate1'];?>"></div></div></td></tr>
	<tr class="evenrow"> <td colspan="2"> <div class="left">Purchase Value: <span style="color:#FF0000">*</span></div> <div class="right"><input type="text" name="purchase_value"  size="45" maxlength="11" id="purchase_value" value="<?php echo $_POST['purchase_value']?>" class="number" /></div></td></tr>
	<tr class="oddrow"><td colspan="2"> <div class="left">Present Condition: <span style="color:#FF0000">*</span></div> <div class="right"><input type="text" name="present_condition"  size="45" id="present_condition" maxlength="45" value="<?php echo $_POST['present_condition']?>" onkeypress="return alphanumeric(event)"  /></div></td></tr>
    ...
    <div class="right"><select name="disposal_head" id="disposal_head" ><option value="">--Select--</option>
	<?php
    ...
    <div class="right"><select name="debit_head" id="debit_head"><option value="">--Select--</option>
	<?php
	...
	<tr class="evenrow"><td colspan="2"> <div class="left">Why such store indented: <span style="color:#FF0000">*</span></div> <div class="right"><input type="text"  name="why_store"  size="45" id="why_store" value="<?php echo $_POST['why_store']?>" maxlength="200" onkeypress="return alphanumeric(event)" /></div></td></tr>
	<tr class="oddrow"><td colspan="2"> <div class="left">Remarks ledger page no: <span style="color:#FF0000">*</span></div><div class="right"><input type="text" name="remark_page"  size="45" maxlength="10" id="remark_page" value="<?php echo $_POST['remark_page']?>" onkeypress="return alphanumeric(event)" /></div></td></tr>
	<tr class="evenrow"><td colspan="2"> <div class="left">Written down value: <span style="color:#FF0000">*</span></div> <div class="right"><input type="text" name="written_value"  size="45" maxlength="11" id="written_value" value="<?php echo $_POST['written_value']?>" class="number"  /></div></td></tr>
	<tr class="oddrow"><td colspan="2"> <div class="left">Reserve price fixed by the committee: <span style="color:#FF0000">*</span></div> <div class="right"><input type="text"  name="reserve_price"  size="45" id="reserve_price" maxlength="11" value="<?php echo $_POST['reserve_price']?>" class="number"  /></div></td></tr>
	<tr class="evenrow"><td colspan="2"> <div class="left">Remarks: </div> <div class="right"><input type="text"  name="remarks" id="remarks" size="45"  maxlength="200" value="<?php echo $_POST['remarks']?>" onkeypress="return alphanumeric(event)" /></div></td></tr>
...
if (isset($_POST['submit']) ){
  ...
  if(!isset($_SESSION['date']) || $_SESSION['date']=='')
    ...
    if($_POST['officername']=='')
   {
     echo "<script type='text/javascript'>document.getElementById('officername').className='ercol';</script>";
	}
	 if (($_POST['officername']!='') && (!eregi('^[0-9a-zA-Z ]+$' , $_POST['officername'])))
	{
	 echo "<script type='text/javascript'>document.getElementById('officername').className='ercol';</script>";
	...
	if($_POST['office']=='')
   {
	...
	if($_POST['own_authority']=='')
   {
     echo "<script type='text/javascript'>document.getElementById('own_authority').className='ercol';</script>";
	}
	 if (($_POST['own_authority']!='') && (!eregi('^[0-9a-zA-Z ]+$' , $_POST['own_authority'])))
	{
	 echo "<script type='text/javascript'>document.getElementById('own_authority').className='ercol';</script>";
	...
	if($_POST['sr_no']=='')
   {
    echo "<script type='text/javascript'>document.getElementById('sr_no').className='ercol';</script>";
	}
	if (($_POST['sr_no']!='') && (!is_numeric($_POST['sr_no'])))
	{
	 echo "<script type='text/javascript'>document.getElementById('sr_no').className='ercol';</script>";
	...
	if($_POST['code']=='')
   {
     echo "<script type='text/javascript'>document.getElementById('code').className='ercol';</script>";
	}
   if($_POST['particulars']=='')
   {
     echo "<script type='text/javascript'>document.getElementById('particulars').className='ercol';</script>";
	}
	 if (($_POST['particulars']!='') && (!eregi('^[0-9a-zA-Z ]+$' , $_POST['particulars'])))
	{
	 echo "<script type='text/javascript'>document.getElementById('particulars').className='ercol';</script>";
	...
	if($_POST['quantity']=='')
   {
	...
	if($_POST['weight']=='')
   {
     echo "<script type='text/javascript'>document.getElementById('weight').className='ercol';</script>";
	}
	if (($_POST['weight']!='') && (!is_numeric($_POST['weight'])))
	{echo "<script type='text/javascript'>document.getElementById('weight').className='ercol';</script>";
	}
   ...
   {
     echo "<script type='text/javascript'>document.getElementById('element_2_2').className='ercol';</script>";
	 echo "<script type='text/javascript'>document.getElementById('element_2_1').className='ercol';</script>";
	 echo "<script type='text/javascript'>document.getElementById('element_2_3').className='ercol';</script>";
	}*/
  
	if($_POST['purchase_value']=='')
   {
     echo "<script type='text/javascript'>document.getElementById('purchase_value').className='ercol';</script>";
	}
	if (($_POST['purchase_value']!='') && (!is_numeric($_POST['purchase_value'])))
	{
	 echo "<script type='text/javascript'>document.getElementById('purchase_value').className='ercol';</script>";
	...
	if($_POST['present_condition']=='')
   {
     echo "<script type='text/javascript'>document.getElementById('present_condition').className='ercol';</script>";
	}
	 if (($_POST['present_condition']!='') && (!eregi('^[0-9a-zA-Z ]+$' , $_POST['present_condition'])))
	{
	 echo "<script type='text/javascript'>document.getElementById('present_condition').className='ercol';</script>";
	...
	if($_POST['disposal_head']=='')
   {
     echo "<script type='text/javascript'>document.getElementById('disposal_head').className='ercol';</script>";
	}
	if($_POST['debit_head']=='')
   {
     echo "<script type='text/javascript'>document.getElementById('debit_head').className='ercol';</script>";
	}
	if($_POST['why_store']=='')
   {
    echo "<script type='text/javascript'>document.getElementById('why_store').className='ercol';</script>";
	}
	 if (($_POST['why_store']!='') && (!eregi('^[0-9a-zA-Z ]+$' , $_POST['why_store'])))
	{
	 echo "<script type='text/javascript'>document.getElementById('why_store').className='ercol';</script>";
	...
	if($_POST['remark_page']=='')
   {
    echo "<script type='text/javascript'>document.getElementById('remark_page').className='ercol';</script>";
	}
	if (($_POST['remark_page']!='') && (!eregi('^[0-9a-zA-Z ]+$' , $_POST['remark_page'])))
	{
	 echo "<script type='text/javascript'>document.getElementById('remark_page').className='ercol';</script>";
	...
	if($_POST['written_value']=='')
   {
    echo "<script type='text/javascript'>document.getElementById('written_value').className='ercol';</script>";
	}
	if (($_POST['written_value']!='') && (!is_numeric($_POST['written_value'])))
	{
	  echo "<script type='text/javascript'>document.getElementById('written_value').className='ercol';</script>";
	...
	if($_POST['reserve_price']=='')
   {
     echo "<script type='text/javascript'>document.getElementById('reserve_price').className='ercol';</script>";
	}
	if (($_POST['reserve_price']!='') && (!is_numeric($_POST['reserve_price'])))
	{
	  echo "<script type='text/javascript'>document.getElementById('reserve_price').className='ercol';</script>";
