<?php
/* $Id: SelectProduct.php 4622 2011-07-03 04:33:19Z daintree $*/
...
echo '</td></tr></table>';
	...
	echo '<tr class="oddrow"><td colspan="3" align="center"><font size="3">Select Product</font></td></tr>
		<tr class="evenrow">
		<th width="33%">' . _('Item Inquiries') . '</th>
		<th width="33%">' . _('Item Transactions') . '</th>
		<th width="33%">' . _('Item Maintenance') . '</th>
	</tr>';
	echo '<tr class="oddrow"><td class="select">';
	/*Stock Inquiry Options */
	echo '</td><td class="select">';
	/* Stock Transactions */
	echo '</td><td class="select">';
	/*Stock Maintenance Options */
    echo '</td><tr class="evenrow"><td colspan="3">';
	echo '<a href="' . $rootpath . '/Stocks.php?">' . _('Add Inventory Items') . '</a><br />';
	echo '</td></tr></table>';
...
echo '<p class="page_title_text">' . ' ' . _(''). '</p>';
echo '<table cellpadding="2" cellspacing="1" ><tr class="evenrow">';
echo '<td ><div class="left">' . _('In Stock Category') . ': <span style="color:#FF0000">*</span></div><div class="right" >';
...
echo '<tr class="oddrow"><td><div class="left">' . _('Enter partial') . ' ' . _('Description: ') . '</div><div class="right">';
if (isset($_POST['Keywords'])) {
	echo '<input type="text" name="Keywords" value="' . $_POST['Keywords'] . '" size="20" maxlength="25" />';
} else {
	echo '<input type="text" name="Keywords" size="20" maxlength="25" />';
}
echo '</td></tr><tr class="evenrow">';
echo '<td align="center"><font size="3"><b>' . _('OR') . ' ' . '</b></font></td></tr>
<tr class="oddrow"><td><div class="left">' . _('Enter partial') . ' <b>' . _('Stock Code') . '</b>:</div><div class="right">';
echo '';
if (isset($_POST['StockCode'])) {
...
<tr class="evenrow"><td colspan="2" align="center"><input type="submit" name="Search" value="' . _('Search Now') . '" /></td></tr>
</table>';
