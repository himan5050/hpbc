...
<div class="breadcrumb">Home &raquo; <a href="audit_mylist.php">Audit List</a>&raquo; <a href="audit_plan_resubmit.php">Audit Plan Resubmit</a></div>
...
<tr class="odd">
  ...
  <div class="left">Auditor: <span style="color:#FF0000">*</span> </div>
   ...
   <tr class="oddrow"> <td ><?php echo $_SESSION['ncs'][$j];?> </td> <td ><?php echo $_SESSION['description'][$j];?> </td><td><?php echo $_SESSION['severity'][$j];?></td><td><?php echo $_SESSION['clause'][$j];?></td><td><a href="audit_plan_resubmit.php?op=delete&no=<?php echo $j;?>&auid=<?php echo $_REQUEST['auid'];?>">Delete</a></td></tr> 
	  ...
	  <td><input type="text" name="ncs" value="<?php echo $_POST['ncs'];?>"></td>
    </tr>
	<tr class="oddrow">
    <td>Description: <span style="color:#FF0000">*</span> </td> 
    <td><input type="text" name="description"  size="45" maxlength="11" value="<?php echo $_POST['description'];?>"/></td></tr>
	<tr class="evenrow">
	  <td>Severity: <span style="color:#FF0000">*</span> </td> 
	  <td><input type="text"  name="severity"  size="45" maxlength="11" value="<?php echo $_POST['severity'];?>"/></td></tr>
	<tr class="oddrow">
	  <td>Standard/Clause: <span style="color:#FF0000">*</span> </td>
	  <td><input type="text"  name="clause"  size="45"  maxlength="45" value="<?php echo $_POST['clause'];?>"/></td>
    </tr>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" id="form-container">
      <tr class="oddrow">
		  ...
		  <div class="right"><input type="file" name="file" /></div>
	  </tr>
      <tr class="evenrow">
