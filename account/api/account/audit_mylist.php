...
$rec_limit = 10;
 ...
 $sql = "SELECT audit_plan.id FROM audit_plan,tbl_corporations where 1=1 ".$cond." and audit_plan.auditor='".$_SESSION['uid']."' and audit_plan.status=0 AND tbl_corporations.corporation_id=audit_plan.auditoffice";
...
$s="select * from audit_plan,tbl_corporations where 1=1 ".$cond."  and auditor='".$_SESSION['uid']."' and audit_plan.status=0 AND tbl_corporations.corporation_id=audit_plan.auditoffice ".$orderby." LIMIT $offset, $rec_limit";
$q=DB_query($s,$db);
$nu=DB_num_rows($q);
