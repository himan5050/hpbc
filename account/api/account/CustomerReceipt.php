...
if (isset($_POST['Process']) && $_POST['BankAccount']!=''){ //user hit submit a new entry to the receipt batch
	...
	/*else if(($_POST['Amount']!='') && ($_POST['Amount'])>0)
	{
	 ...
	 else if ($_POST['PayeeBankDetail'] == '' && $_POST['BankAccount']=='1030') {
...
echo '<div align="right"><a href="/'.$u[1].'/generatevoucherpdf.php?voucher=sc-'.$voucherno.'&op=cash" target="_blank"><img src="images/pdf_icon.gif"/></a></div>';

echo '<br /><div align="center"><a href="' . $_SERVER['PHP_SELF'] .'?NewReceipt=Yes&Type=GL">' . _('') . '<input type="button" value="Enter another Receipt Voucher"/></a></div><br />';
if($_SESSION['type'] == 'loan')
{
	echo '&nbsp;&nbsp;<div align="center"><a href="/'.$u[1].'/loan/pendingvouchers">' . _('') . '<input type="button" value="Back To Pending Vouchers"/></a></div>';
}
...
echo '<div class="breadcrumb">Home &raquo; <a href="'.$_SERVER['PHP_SELF'].'">Receipt Entry</a></div><table class=selection>
...
<tr class="evenrow"><td><div class="left">' . _('Cash/Bank Account') . ': <span style="color:#FF0000">*</span></div>
				 <div class="right"><select tabindex=1 name="BankAccount" onChange="chequeno(this.value)" >';
...
echo '<tr class="evenrow"><td><div class="left">' . _('Narrative') . ':</div><div class="right"><input type="text" name="BatchNarrative" value="'. $_SESSION['ReceiptBatch']->BatchNarrative . '" onkeypress="return alphanumeric(event)" tabindex=5/> </div></td></tr>';
...
if (isset($_SESSION['ReceiptBatch'])){
	...
	foreach ($_SESSION['ReceiptBatch']->Items as $ReceiptItem) {
		...
		echo '<tr class="even">
				<td >' . number_format($ReceiptItem->Amount,2) . '</td>
	...
	echo '<tr ><td colspan="6"><b>' . number_format($BatchTotal,2) . '</b></td></tr></table>';
}
...
// End select tag
	...
	echo '<tr class="evenrow"><td><div class="left">' . _('GL Account') . ': <span style="color:#FF0000">*</span></div><div class="right"><select tabindex=8 name="GLCode">';
...
if (((isset($_SESSION['CustomerRecord'])
	...
	echo '<tr class="oddrow"><td><div class="left">' . _('Amount of Receipt') . ': <span style="color:#FF0000">*</span></div>
		<div class="right"><input tabindex=9 type="text" name="Amount" maxlength=11 size=13 class=number value="' . $_POST['Amount'] . '"></div></td>
	</tr>';
	...
	echo '<tr class="evenrow"><td><div class="left">' . _('Payee Bank Details') . ': <span style="color:#FF0000">*</span></div>
		<div class="right"><input tabindex=12 type="text" name="PayeeBankDetail" maxlength=45 size=20 value="' . $_POST['PayeeBankDetail'] . '"onkeypress="return alphanumeric(event)"></div></td></tr>';
...
//		<td><input tabindex=13 type="text" name="Narrative" maxlength=30 size=32 value="' . $_POST['Narrative'] . '"></td></tr>';
	...
	echo '<div class="right"><input type="text" tabindex=13 name="Narrative" maxlength="200" size="82" value="' . $_POST['Narrative'] . '" onkeypress="return alphanumeric(event)"/></div></td></tr>';
