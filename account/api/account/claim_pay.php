...
if($_REQUEST['type']=='loan')
{
	if($_REQUEST['vou']=='payment')
	{
		header("location:Payments.php?Debit=".$_REQUEST['Debit']."&GLManualCode=".$_REQUEST['GLManualCode']."&GLCode=".$_REQUEST['GLCode']."&clid=".$_REQUEST['clid']."&type=loan");
	}
	if($_REQUEST['vou']=='journal')
	{
	...
	{
		header("location:CustomerReceipt.php?Debit=".$_REQUEST['Debit']."&GLManualCode=".$_REQUEST['GLManualCode']."&GLCode=".$_REQUEST['GLCode']."&clid=".$_REQUEST['clid']."&type=loan&NewReceipt=Yes&Type=GL");
	}
}
