...
<div class="breadcrumb">Home &raquo; <a href="<?php echo $_SERVER['PHP_SELF'];?>">Bank Reconcillation</a></div>
<?php 
...
/*Get the balance of the bank account concerned */
	...
	echo '<br /><table class="selection"><tr class="oddrow"><td colspan="7"><h2>Bank Reconcillation Statement</h2></td></tr><tr><td colspan="7" align="right"><a href="/'.$u[1].'/generateaccountpdf.php?bankaccount='.$_POST['BankAccount'].'&op=reconcillation" target="blank"><img src="images/pdf_icon.gif"/></a></td></tr>
...
$DisplayTranDate=$DisplayTranDat[0]."-".$DisplayTranDat[1]."-".$DisplayTranDat[2];
	...
	//end of while loop
	echo '<tr></tr>
			<tr class=even><td colspan=6><b>' . _('Total of all unpresented cheques') . '</b></td><td align="right" class="number">' . number_format($TotalUnpresentedCheques,$CurrDecimalPlaces) . '</td></tr>';
