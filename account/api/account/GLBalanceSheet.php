...
$bald=explode('/',$BalanceDate);
   // echo '<a href="/'.$u[1].'/generateinventorypdf.php?op=balancesheet&period='.$_POST['BalancePeriodEnd'].'&Detail=Detailed&earning='.$RetainedEarningsAct.'" target="_blank">';
	echo '<div class=invoice><table class="selection"><tr><th colspan=6><div class="centre"><b>' .
		_('Balance Sheet as at') . ' ' . $bald[2].'-'.$bald[1].'-'.$bald[0] .'</b></div></th></tr><tr><td colspan="6" align="right"><a href="/'.$u[1].'/generateaccountpdf.php?op=balancesheet&period='.$_POST['BalancePeriodEnd'].'&Detail=Detailed&earning='.$RetainedEarningsAct.'" target="_blank"><img src="images/pdf_icon.gif"/></a></td></tr>';
