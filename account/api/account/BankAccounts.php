...
/* $Id: BankAccounts.php 4617 2011-07-02 22:51:40Z daintree $*/
...
if (isset($SelectedBankAccount) AND !isset($_GET['delete'])) {
	...
	$_POST['BankAccounttype'] = $myrow['type'];
...
echo '<tr><td>' . _('Bank Account Name') . ': </td>
		...
		<tr><td>' . _('Bank Account Code') . ': </td>
			...
			<tr><td>' . _('Bank Account Type') . ': </td>
			<td><select name="BankAccounttype">';
			if($_POST['BankAccounttype']=='Cash')
			{ 
			echo '<option value="Cash" "selected">Cash</option>
			      <option value="Cheque">Bank</option>';
		    }
			else if($_POST['BankAccounttype']=='Bank')
			{ 
			echo '<option value="Cash" >Cash</option>
			      <option value="Cheque" "selected">Bank</option>';
		    }
			else
			{
			 echo '<option value="Cash" >Cash</option>
