...
<tr class="oddrow">
  ...
  <tr class="evenrow">
   <td colspan="2"> <div class="left">Items/Equipment details :<span style="color:#FF0000">*</span></div>
    <div class="right"><input type="text" name="itemdetails"  size="45" maxlength="45"  value="<?php echo $por['itemdetails'];?>"/><input type="hidden" name="id" value="<?php echo $_REQUEST['id'];?>"></div></td>
  </tr>
   <tr class="oddrow">
	...
	{ 
	  ...
	  {
	    echo '<option value="'.$icr['code'].'" selected>'.$icr['code'].'-'.$icr['name'].'</option>';
	  }
	  else
	  {
	  echo '<option value="'.$icr['code'].'">'.$icr['code'].'-'.$icr['name'].'</option>';
	  }
	}
	?>
	</select></div></td>
  ...
  <tr class="evenrow">
    <td colspan="2"> <div class="left">Reference Number :<span style="color:#FF0000">*</span></div>
   <div class="right"><input type="text" name="referencenum"  size="45" maxlength="10"  value="<?php echo $por['referencenum'];?>"/></div></td>
  </tr>
  
  <tr class="oddrow">
  <td colspan="2"> <div class="left">Quantity Required :<span style="color:#FF0000">*</span></div>
    <div class="right"><input type="text" name="quantity_required"  size="45" maxlength="10" value="<?php echo $por['quantity_required'];?>"/></div></td>
  </tr>
  <tr class="evenrow">
  ...
  <tr class="oddrow">
    ...
    <div class="right"><input type="text" name="amountitem"  size="45" maxlength="10" value="<?php echo $por['amountitem'];?>"/></div></td>
  </tr>
  ...
  <td colspan="2"> <div class="left">Remarks :</div>
    <div class="right"><input type="text" name="remarks"  size="45" maxlength="200" value="<?php echo $por['remarks'];?>"/></div></td>
  </tr>
