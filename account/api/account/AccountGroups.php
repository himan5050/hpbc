...
if ((isset($_POST['SelectedAccountGroup']) OR isset($_GET['SelectedAccountGroup'])) AND !isset($_REQUEST['delete'])) {
		echo '<div class="breadcrumb">Home &raquo; <a href="AccountGroups.php">Account Groups</a> '; if(!isset($_REQUEST['delete'])) { echo'&raquo; <a >Edit Account Group</a>';} echo '</div>';
	...
	echo '<tr class="oddrow"><td><div class="left">' . _('Description') . ': <span style="color:#FF0000">*</span></div><div class="right"><textarea tabindex="6" name="description" rows="5" cols="45" style="width: 210px; height: 48px;">' . $_POST['description'] . '</textarea></div></td></tr>';
	echo '<tr class="evenrow"><td colspan="2" align="center"><div class="centre"><a href="AccountGroups.php"><input tabindex="7" type="button" name="back" value="Back"/></a> <input tabindex="8" type="submit" name="submit" value="' . _('Save') . '" /></div></td></tr>';
