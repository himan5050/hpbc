...
?>
<div class="breadcrumb">Home &raquo; <a href="audit_report_approvelist.php">Audit List</a> &raquo; <a href="<?php echo $_SERVER['PHP_SELF'];?>">Audit Plan</a></div>
...
<!--  <tr class="evenrow">
 ...
 <tr class="evenrow">
    ...
    <div class="right"><input type="text" name="period" id="period" size="45" maxlength="45" onkeypress="return alphanumeric(event)" value="<?php echo $_POST['period'] ?>" /></div></td>
  </tr>
