...
/* $Id: InventoryPlanning.php 4635 2011-07-19 09:35:25Z daintree $ */
...
// Also need to add in the demand as a component of an assembly items if this items has any assembly parents.
	...
	/*if $FromCriteria is not set then show a form to allow input	*/
		...
		echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';
         echo '<tr class="oddrow"><td align="center" colspan="2"><font size="3">Inventory Planning</font></td></tr>';
		...
		echo "<tr class='evenrow'><td colspan='2' align='center'><div class='centre'><input type='submit' Name='PrintPDF' value='" . _('Print PDF') . "' /></div></td></tr>";
		echo"</table></form>";
	}
	include('includes/footer.inc');
