...
echo '<div class="breadcrumb">Home &raquo; <a href="'.$_SERVER['PHP_SELF'].'">Gl Budgets</a></div><form action="' . $_SERVER['PHP_SELF'] . '" method="post" name="selectaccount">';
...
// Table Headers
	...
	echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';
	echo '<br /><div style="overflow-x:scroll; width:910px;"><table  width="100%">';
