...
<div class="breadcrumb">Home &raquo; <a href="audit_mylist.php">Audit List</a> &raquo; <a href="<?php echo $_SERVER['PHP_SELF'];?>">Submit Audit Report</a></div>
  ...
  <td colspan="2" align="center"><h2>Submit Audit Report</h2></td>
    ...
    <tr class="evenrow"> <td ><div class="left">Audit Date: <span style="color:#FF0000">*</span> </div> 
      <input type="hidden" name="uid" value="<?php echo $_REQUEST['uid']?>" /><div class="right"><!--<div id="li" style="width:353px;">
		...
		</script>	</div>--><div  id="date"><input type="text"  name="JournalProcessDate" class="date" alt="<?php echo $_SESSION['DefaultDateFormat'];?>" maxlength=10 size=11 onChange="isDate(this, this.value, '<?php echo $_SESSION['DefaultDateFormat'];?>')" value="<?php echo $_POST['JournalProcessDate'];?>"></div></div></tr>
                       
    
	<tr class="oddrow">
	  <td><div class="left">Office: <span style="color:#FF0000">*</span> </div><div class="right"><select name="auditoffice" id="auditoffice"><option value="">--Select --</option>
    <?php
	...
	<tr class="evenrow">
	  ...
	  <div class="right"><input type="text" name="remark" id="remark" size="45" maxlength="45" value="<?php echo $_POST['remark']?>" /></div></td></tr>
      </table>
       <br/><br/>
    <table width="553" border="0" cellpadding="2" cellspacing="1">
   ...
   <tr class="<?php echo $cl;?>"> <td ><?php echo $_SESSION['ncs'][$j];?> </td> <td ><?php echo $_SESSION['description'][$j];?> </td><td><?php echo $_SESSION['severity'][$j];?></td><td><?php echo $_SESSION['clause'][$j];?></td></tr> 
    ...
    <br/>
	  ...
	  <div class="right"><input type="text" name="ncs" value="<?php echo $_POST['ncs'];?>"></div></td>
    </tr>
	<tr class="oddrow">
    <td><div class="left">Description: <span style="color:#FF0000">*</span></div>
    <div class="right"><input type="text" name="description"  size="45" maxlength="11" value="<?php echo $_POST['description'];?>"/></div></td></tr>
	<tr class="evenrow">
	  <td><div class="left">Severity: <span style="color:#FF0000">*</span></div>
	  <div class="right"><input type="text"  name="severity"  size="45" maxlength="11" value="<?php echo $_POST['severity'];?>"/></div></td></tr>
	<tr class="oddrow">
	  <td><div class="left">Standard/Clause: <span style="color:#FF0000">*</span> </div>
	  <div class="right"><input type="text"  name="clause"  size="45"  maxlength="45" value="<?php echo $_POST['clause'];?>"/></div></td>
    </tr>
	...
	<br/>
    <table>
      <tr class="oddrow"><td><div class="left">Attach NCs Copy :</div><div class="right"><input type="file" name="file" /></div></td></tr>
    <tr class="evenrow"><td colspan="2" align="center"><input  type="submit" name="submit" value="Save" /> <input  type="reset" name="reset" value="Reset" /></td>
  </tr>
</table>
