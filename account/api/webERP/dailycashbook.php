...
FROM banktrans,gltrans,chartmaster WHERE banktrans.transdate ='".$date."'and banktrans.transno=gltrans.typeno and banktrans.transdate=gltrans.trandate and gltrans.account=chartmaster.accountcode ";
	...
	if($ssnu>0)
	{
	$data="<div style='overflow-x:scroll;  width:940px; border:#ccc 1px solid;'><table border='1' cellpadding='2' cellspacing='1'><tr class='oddrow'><td align='left' colspan='10'><h2>Daily Cash Book</h2></td></tr><tr><td align='center' colspan='8'>Opening Balance:".round(($opbr['totamount']+$acto),2)."</td><td align='right' colspan='2'><a href='/".$u[1]."/generateaccountpdf.php?sdate=".$date."&op=daily_cashbook' target='blank'><img src='images/pdf_icon.gif'/></a></td></<tr><tr ><td colspan='10' align='right'><strong>&nbsp;&nbsp;Report Date :</strong> &nbsp;&nbsp; ".$dat[0]."-".$dat[1]."-".$dat[2]."</td></tr><tr><td colspan='5' align='center' width=450><b>Receipts</b></td><td colspan='5' align='center' width=600><b>Payments</b></td></tr>
<tr><th>Voucher No.</th><th>A/C Head</th><th>Particulars</th><th>Cash Amount</th><th>Bank Amount</th><th width='80px'>Voucher No.</th><th>A/C Head</th><th>Particulars</th><th>Cash Amount</th><th>Bank Amount</th></tr>";		
	...
	//echo $r['account'];
	  ...
	  {  
	    ...
	    $data.="<tr class='odd'><td>".$r['voucher_no']."</td><td>".$r['accountname']."</td><td>".$r['ref']."</td><td align='right'>".$cash."</td><td align='right'>".$cheque."</td><td>--</td><td>--</td><td>--</td><td>--</td><td>--</td></tr>";
		}
		else if($r['bamount']<0)
	  {
	     if($r['banktranstype']=='Cash')
	    ...
	    $data.="<tr class='odd'><td>--</td><td>--</td><td>--</td><td>--</td><td>--</td><td>".$r['voucher_no']."</td><td>".$r['accountname']."</td><td>".$r['ref']."</td><td align='right'>".$cash."</td><td align='right'>".$cheque."</td></tr>";
		}
	}	
	}
	}
