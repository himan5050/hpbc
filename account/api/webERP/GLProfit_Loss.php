...
. _('webERP is an "accrual" based system (not a "cash based" system).  Accrual systems include items when they are invoiced to the customer, and when expenses are owed based on the supplier invoice date.') . '</div>';
	...
	<tr class="oddrow"><td colspan="2" align="center"><font size="3">Profit and Loss Report</font></td></tr>
			<tr class="evenrow"><td>' . _('Select Period From') . ':</td>
	...
	echo '<tr class="evenrow"><td>'._('Detail Or Summary').':</td>
			...
			<tr class="oddrow"><td colspan="2" align="center"><input type="submit" name="ShowPL" value="' ._('Show on Screen (HTML)') . '">&nbsp;&nbsp;
