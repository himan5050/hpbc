...
/* $Id: StockUsage.php 4632 2011-07-16 02:59:14Z daintree $*/
...
if (($myrow[2]=='K') OR ($myrow[2]=='A') OR ($myrow[2]=='D')) {
	...
	echo '<font  size=3><b>' . $StockID . ' - ' . $myrow[0] . '</b></font>';
	...
	echo '<tr class="oddrow"><td colspan="2" align="center"><font size=3 >' . _('Item') . ' : ' . $StockID . ' - ' . $myrow[0] . ' (' . _('in units of') . ' :' . $myrow[1] . ')</font></td></tr>';
}

echo '<form action="' . $_SERVER['PHP_SELF'] . '" method=post>';
		
echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';
echo '<tr class="evenrow"><td>' . _('Stock Code') . ':</td><td><input type="text" name="StockID" size="21" maxlength="20" value="' . $StockID . '" /></td></tr><tr class="oddrow"><td>';
...
echo ' </tr><tr class="evenrow"><td colspan="2" align="center"><input type=submit name="ShowUsage" value="' . _('Show Stock Usage') . '">';
