...
/* $Id: PDFStockCheckComparison.php 4619 2011-07-03 03:01:39Z daintree $*/
...
/*First off do the Inventory Comparison file stuff */
    ...
    echo'<tr class="oddrow"><td colspan="2" align="center"><font size="3">Stock Check Comparison</font> </td></tr>';
	echo '<tr class="evenrow"><td>' . _('Choose Option'). ':</font></td><td><select name="ReportOrClose">';
	...
	echo '<tr class="oddrow"><td>'. _('Action for Zero Counts') . ':</td><td><select name="ZeroCounts">';
