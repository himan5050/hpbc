...
if (! isset($_GET['delete'])) {
	...
	echo '<tr class="oddrow"><td colspan="2"> <div class="left">' . _('Section Description') . ': <span style="color:#FF0000">*</span>' . '</div>
		<div class="right"><input tabindex="2" ' . (in_array('SectionName',$Errors) ?  'class="inputerror"' : '' ) .' type="text" name="SectionName" size="30" maxlength="30" value="' . $_POST['SectionName'] . '" onkeypress="return alphanumeric(event)"  /></div>
		</tr>';
