...
/* $Id: InventoryValuation.php 4635 2011-07-19 09:35:25Z daintree $ */
...
/*Print out the grand totals */
	...
	/*if $FromCriteria is not set then show a form to allow input	*/
		...
		echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';
         echo'<tr class="oddrow"><td colspan="2" align="center"><font size="3">Inventory Valuation</font></td></tr>';
		...
		echo '<tr class="oddrow"> <td>' . _('To Inventory Category Code') . ':</td>
		...
		echo '<tr class="evenrow"><td>' . _('For Inventory in Location') . ':</td>
		...
		echo '<tr class="oddrow"><td>' . _('Summary or Detailed Report') . ':</td>
