...
if (! isset($_POST['BalancePeriodEnd']) or isset($_POST['SelectADifferentPeriod'])){
	...
	<tr class="oddrow"><td colspan="2" align="center"><font size="3">Balance Sheet</font></td></tr>
	
	<tr class="evenrow"><td>'._('Select the balance date').':</td><td><select Name="BalancePeriodEnd">';
