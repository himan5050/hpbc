...
/* $Id: PDFChequeListing.php 4632 2011-07-16 02:59:14Z daintree $*/
...
if (!isset($_POST['FromDate']) OR !isset($_POST['ToDate'])){
	...
	echo '<table cellpading="2" cellspacing="1" >
	<tr class="oddrow"><td colspan="2" align="center">
<font size="3">	Payment Listing</font>
	</td></tr>
	 			<tr class="evenrow">
	 ...
	 echo '<tr class="oddrow"><td>' . _('Enter the date to which cheques are to be listed') . ':</td>
	 ...
	 echo '<tr class="evenrow"><td>' . _('Bank Account') . '</td><td>';
	 ...
	 echo '<tr class="oddrow"><td>' . _('Email the report off') . ':</td>
			<td><select name="Email">';
	 echo '<option selected value="No">' . _('No') . '</option>';
	 echo '<option value="Yes">' . _('Yes') . '</option>';
	 echo '</select></td>
			</tr>
			<tr class="evenrow"><td colspan="2" align="center"><input type=submit name="Go" value="' . _('Create PDF') . '"></td></tr>
			</table>
			';
