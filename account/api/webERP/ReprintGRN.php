...
echo '<tr class="oddrow"><td colspan="2" align="center"><font size="3" >' . _('Select a purchase order') . '</font></td></tr>';
echo '<tr class="evenrow"><td>' . _('Enter a Purchase Order Number') . '</td>';
echo '<td>' . '<input type="text" name="PONumber" class="number" size="7" value="'.$_POST['PONumber'].'" /></td></tr>';
echo '<tr class="oddrow"><td colspan=2 style="text-align: center">' . '<input type="submit" name="Show" value="Show GRNs" /></td></tr>';
