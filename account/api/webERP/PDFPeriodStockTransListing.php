...
if (!isset($_POST['FromDate'])){
	...
	echo '
	<tr class="oddrow"><td colspan="2" align="center"><font size="3">Period Stock Trans Listing</font></td></tr>
	...
	echo '<tr class="evenrow"><td>' . _('Transaction type') . '</td><td>';
	...
	echo '<tr class="oddrow"><td>' . _('For Stock Location') . ':</td>
