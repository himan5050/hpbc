<?php
/* $Id: StockDispatch.php 4618 2011-07-02 23:04:59Z daintree $*/
...
/*Print out the grand totals */
	...
	<tr class="oddrow"><td align="center" colspan="2"><font size="3">Stock Dispatch</font></td></tr>
	
	<tr class="evenrow"><td>' . _('Dispatch Percent') . ':</td><td><input type ="text" name="Percent" class="number" size="8" value=0>';
	echo '<tr class="oddrow"><td>' . _('From Stock Location') . ':</td><td><select name="FromLocation"> ';
	...
	echo '<tr class="evenrow"><td>' . _('To Stock Location') . ':</td><td><select name="ToLocation"> ';
	while ($myrow=DB_fetch_array($resultStkLocs)){
	...
	echo '<tr class="oddrow"><td>' . _('In Stock Category') . ':</td><td><select name="StockCat">';
	...
	echo '<tr class="evenrow"><td>' . _('Report Type') . ':</td>';
	...
	echo '<tr class="oddrow"><td>' . _('Template') . ':</td>';
	...
	echo '</select></td></tr>
	<tr class="evenrow"><td colspan="2" align="center"><input type="submit" name="PrintPDF" value="' . _('Print PDF') . '"></td></tr>
	';
