...
if ((isset($_POST['BatchInput']) and $_POST['BankAccount']!=''))
{
...
if (!isset($_GET['Delete']) AND isset($_SESSION['ReceiptBatch'])){ //always process a header update unless deleting an item
	...
	$_SESSION['ReceiptBatch']->Narrative = $_POST['Narrative'];
	$_SESSION['ReceiptBatch']->BatchNarrative=$_POST['BatchNarrative'];
...
$file=fopen("voucher.txt","r");
	...
	$voucherno=$vouchno[1];
	  ...
	  fclose($file1);
prnMsg( _('Voucher') . ' ' . $vounumber . ' ' . _('has been successfully entered into the database'),'success');
...
echo '<tr class="evenrow"><td><div class="left">' . _('Narrative') . ':</div><div >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea name="BatchNarrative" onkeypress="return alphanumeric(event)" cols="28" tabindex=5>' . $_SESSION['ReceiptBatch']->BatchNarrative . '</textarea></div></td></tr>';
...
if (isset($_SESSION['ReceiptBatch'])){
	...
	foreach ($_SESSION['ReceiptBatch']->Items as $ReceiptItem) {
		...
		echo '<tr class="even">
				...
				<td>'.$ReceiptItem->GLCode.' - '.$myrow['accountname'].'</td>
				<td style="max-width:70px; word-wrap:break-word;">'.$ReceiptItem->Narrative . '</td>
