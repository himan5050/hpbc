<?php
/* $Id: StockLocMovements.php 4622 2011-07-03 04:33:19Z daintree $*/
...
<tr class="oddrow"><td colspan="2" align="center"><font size="3">Stock Loc Movements</font></td></tr>
...
echo '<tr class="oddrow"><td> ' . _('Show Movements before') . ': </td><td><input type="text" name="BeforeDate" size=12 maxlength=12 Value="' . $_POST['BeforeDate'] . '"></td></tr>';
echo ' <tr class="evenrow"><td>' . _('But after') . ':</td><td> <input type=TEXT name="AfterDate" size=12 maxlength=12 Value="' . $_POST['AfterDate'] . '">';
echo '</td></tr>
<tr class="oddrow"><td colspan="2" align="center"><input type=submit name="ShowMoves" VALUE="' . _('Show Stock Movements') . '"></td></tr>
