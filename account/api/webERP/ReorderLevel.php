...
/* $Id: ReorderLevel.php 4624 2011-07-05 10:36:13Z daintree $*/
...
/*Print out the grand totals */
	...
	<tr class="oddrow"><td colspan="2" align="center"><font size="3">Reorder Level</font></td></tr>
	<tr class="evenrow"><td>' . _('From Stock Location') . ':</td><td><select name="StockLocation"> ';
	...
	echo '</select></td></tr>
	<tr class="evenrow"><td align="center" colspan="2"><input type=submit name="PrintPDF" value="' . _('Print PDF') . '"></td></tr>
	';
	echo '</table><br />';
