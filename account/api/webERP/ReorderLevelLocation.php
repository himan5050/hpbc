<?php
/* $Revision: 1.1 $ */
/* $Id: ReorderLevelLocation.php 4624 2011-07-05 10:36:13Z daintree $*/
...
if (isset($_POST['submit']) or isset($_POST['update'])) {
	...
	<tr class="oddrow"><td colspan="2" align="center"><h2>Reorder Level Location</h2></td></tr>
				<tr class="evenrow">
					<td colspan="2"> <div class="left">' . _('Location') . ':</div>
					<div class="right"><select name="StockLocation">';
	...
	echo '<tr class="oddrow"><td colspan="2"> <div class="left">' . _('Category') . ':</div>
	...
	echo'<tr class="evenrow">
				<td colspan="2"> <div class="left">' . _('Number Of Days Sales') . ':</div>
				<div class="right"><input type="text" class="number" name="NumberOfDays" MAXLENGTH =3 size=4 value=0></div>';
	echo '<tr class="oddrow"><td colspan="2"> <div class="left">' . _('Order By') . ':</div>
				<div class="right"><select name="order">';
	echo '<option value="1">'. _('Total Invoiced') . '</option>';
	echo '<option value="2">'. _('Code') . '</option>';

	echo '</select></div></td></tr>
	<tr class="evenrow"><td colspan="2" align="center"><input type=submit name="submit" value="' . _('Submit') . '"></td></tr>
	
	';
	echo '</table><br /><p><div class="centre"></div></p>';
