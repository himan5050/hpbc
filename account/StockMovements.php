...
/* $Id: StockMovements.php 4632 2011-07-16 02:59:14Z daintree $*/
...
echo '<br /><table cellpadding=2 cellspacing="1">';
echo '
<tr class="oddrow"><td colspan="10" align="center"><font size="3">Stock Movements</font></td></tr>
<tr class="evenrow" ><td >' . _('Stock Code') . ':&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="StockID" size=21 value="' . $StockID . '" maxlength=20></td>
...
<tr class="oddrow"><td >'.  _('Show Movements before'). ':&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="BeforeDate" class="date" alt="'.$_SESSION['DefaultDateFormat'].'" size="12" maxlength="12" VALUE="' . $_POST['BeforeDate'] . '">
</td>';

echo '  <td >' .  _('Show Movements after'). ':&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="AfterDate" class="date" alt="'.$_SESSION['DefaultDateFormat'].'" size="12" maxlength="12" VALUE="' . $_POST['AfterDate'] . '"></td>';

echo '<tr class="evenrow"><td colspan="2" align="center">';
echo ' <input type="submit" name="ShowMoves" value="' . _('Show Stock Movements') . '"></td></tr>';
...
$tableheader = '</table><br/><br/><table cellspacing="1" cellpadding="2"><tr class="evenrow">
				<td>' . _('Type') . '</td>
				<td>' . _('Number') . '</td>
				<td>' . _('Date') . '</td>
				<td>' . _('Customer') . '</td>
