<?php
/* $Id: StockSerialItemResearch.php 4627 2011-07-08 10:30:40Z daintree $*/
...
echo'<table cellspacing="1" cellpadding="2"><tr class="oddrow"><td align="center" colspan="2"><font size="3">Stock Serial Item Research</size></td></tr>';
echo  '<tr class="evenrow"><td>'._('Serial Number') .':</td><td> <input ID="serialno" name="serialno" size=21 maxlength=20 VALUE="'. $SN . '">
</td></tr>
<tr class="oddrow"><td colspan="2" align="center"><input type=submit name=submit></td></tr></table></div><br />
</form>';
