...
<body>
<div class="breadcrumb"><a href="/<?php echo $u[1]; ?>">Home</a> &raquo; <a href="audit_mylist.php">Audit List</a> &raquo; <a href="<?php echo $_SERVER['PHP_SELF'];?>">Audit Detail</a></div>
...
?>
 <tr class="<?php echo $cla;?>">
  ...
  {
  ?></table><br /><table>
  <tr class="odd"><td colspan="4" align="center"><h2>Queries</h2></td>
  </tr>
  <tr class="even"><td colspan="4" align="right" class="back"><?php if($r1['querystatus']=='1') {?><a href="audit_plan_resubmit.php?auid=<?php echo $_GET['auid'];?>">Resubmit</a> <?php } ?></td>
  </tr>
 <?php }
  $k=0;
