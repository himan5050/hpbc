...
echo '<div class="breadcrumb"><a href="/'.$u[1].'">Home</a> &raquo; <a href="'. $_SERVER['PHP_SELF'].'">Audit Report</a></div>';
...
<td> <div class="divwrapper"><div class="maincol"><b>To Date: </b><span style="color:#FF0000">*</span></div>
	...
	<span>
        ...
        <td><div class="divwrapper"><div class="maincol"><b>Office: </b><span style="color:#FF0000">*</span></div>
  <div class="maincolcel">  <select name="auditoffice"><option value="">--Select --</option>
	...
	?>
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td>&nbsp;</td></tr>
<tr> <td colspan="6"><div class="generatebtn" style="margin-right:30px;"><input  type="submit" name="submit" value="Generate" /></div></td>
  </tr>
  <tr>
...
if($sdate=='')
 ...
 if($InputError!=1)
	...
	$corpbranch=getCorporationBranch($_SESSION['uid'],$db);
	  $output="<table><tr class=oddrow><td colspan=11><h2>Audit Report</h2></td></tr><tr><td colspan='10' align='right'><a href='/".$u[1]."/generateaccountpdf.php?sdate=".strtotime($sdate)."&edate=".strtotime($edate)."&office=".$_REQUEST['auditoffice']."&op=audit&branch=".$corpbranch."' target='blank'><img src='images/pdf_icon.gif'/></a></td></tr>
	  <tr><th width='5%'><b>S. No.</b></th><th width='10%'><b>Audit Date</b></th><th width='10%'><b>Office Name</b></th><th width='10%'><b>Section Name</b></th><th width='10%'><b>Auditor</b></th><th width='12%'><b>NCs</b></th><th width='8%'><b>Description</b></th><th width='10%'><b>Severity</b></th><th width='10%'><b>Clause</b></th><th width='10%'><b>Action Taken</b></th><th width='10%'><b>Remark</b></th></tr>";
	  ...
	  $nctd ="<table style='border:none;'>";
	   ...
	   $output .="<tr class='".$cl."'><td valign='top' width='5%'>".$k."</td><td valign='top' width='10%'>".date('d-m-Y',$r['auditdate'])."</td><td valign='top' width='10%'>".ucwords($r2['corporation_name'])."</td><td valign='top' width='10%'>".ucwords($r['section'])."</td><td valign='top' width='10%'>".ucwords($r1['name'])."</td><td colspan='5' width='10%'>".$nctd."</td><td valign='top'>".ucwords($r['remark'])."</td></tr>";
	   	$k++;	   
	  }
	$output .="</table>";
	echo $output;
