<?php
/* $Id: SelectGLAccount.php 4618 2011-07-02 23:04:59Z daintree $*/
...
if (!isset($AccountID)) {
	...
	<tr class="oddrow"><td colspan="5" align="center"><font size="3">General Ledger Accounts</font></td></tr>
		<tr class="evenrow">
		<td>' . _('Enter extract of text in the Account name') .":</td>
		<td><input type='Text' name='Keywords' size=20 maxlength=25></td></tr>
		<tr class='oddrow'><td colspan='2' align='center'><font size=3><b>" .  _('OR') . "</b></font></td></tr>
 		<tr class='evenrow'><td>" . _('Enter Account No. to search from') . ":</td>
		<td><input type='Text' name='GLCode' size=15 maxlength=18 class=number ></td></tr>
