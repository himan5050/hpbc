...
/* $Id: InventoryQuantities.php 4635 2011-07-19 09:35:25Z daintree $ */
...
echo '<div class="page_help_text">' . _('Use this report to display the quantity of Inventory items in different categories.') . '</div><br />';
	...
	echo '<table  cellspacing="1" cellpadding="2"><tr class="oddrow"><td align="center" colspan="2"><font size="3">Inventory Quantities</font></td></tr>';
	echo '<tr class="evenrow"><td>' . _('Selection') . ':</td><td><select name="Selection">';
	...
	echo '<tr class="oddrow"><td>' . _('In Stock Category') . ':</td>
