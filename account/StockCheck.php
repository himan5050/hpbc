...
/* $Id: StockCheck.php 4617 2011-07-02 22:51:40Z daintree $*/
...
/*First off do the stock check file stuff */
	...
	/*if $FromCriteria is not set then show a form to allow input	*/
		...
		echo '<form action="' . $_SERVER['PHP_SELF'] . '" method="POST"><table cellspacing="1" cellpadding="2">';
		echo '<input type="hidden" name="FormID" value="' . $_SESSION['FormID'] . '" />';
        echo '<tr class="oddrow"><td colspan="2" align="center"><font size="3"> Stock Check</font></td></tr>';
		echo '<tr class="evenrow"><td>' . _('From Inventory Category Code') . ':</font></td>
		...
		echo '<tr class="oddrow"><td>' . _('To Inventory Category Code') . ':</td><td><select name="ToCriteria">';
		...
		echo '<tr class="evenrow"><td>' . _('For Inventory in Location') . ':</td><td><select name="Location">';
		...
		echo '<tr class="oddrow"><td>' . _('Action for Stock Check Freeze') . ':</td>
		...
		echo '<tr class="evenrow"><td>' . _('Show system quantity on sheets') . ':</td><td>';
		...
		echo '<tr class="oddrow"><td>' . _('Only print items with non zero quantities') . ':</td><td>';
		if (isset($_POST['NonZerosOnly']) and $_POST['NonZerosOnly'] == false){
			...
			<tr class="evenrow"><td colspan="2" align="center"><input type=Submit Name="PrintPDF" Value="' . _('Print and Process') . '"></td></tr>
