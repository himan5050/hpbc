...
echo '<div class="breadcrumb"><a href="/'.$u[1].'">Home</a> &raquo; <a href="'. $_SERVER['SCRIPT_NAME'].'">Receive Item</a></div>';
  ...
  if($_POST['itemcode']=='')
	...
	if($_POST['verifyphysically']=='')
   {
	...
	if($InputError!=1)
	{
	 ...
	 unset($_POST);
	  unset($_REQUEST);
	  echo "<div class='success'>Item For Code ".$_POST['itemcode']." has been added succesfully</div>";
	 }						
	}
}
...
<tr class="oddrow"><td colspan="2" align="center"><h2>Receive Items</h2></td></tr>
 ...
 <tr class="evenrow">
  ...
  <tr class="evenrow">
    ...
    <div class="right"><input type="text" class="number" name="amountitem" id="amountitem" size="45" maxlength="11" value="<?php echo $_POST['amountitem']?>"  /></div></td>
  </tr>
 <tr class="oddrow">
