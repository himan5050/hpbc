...
/* $Id: index.php 4635 2011-07-19 09:35:25Z daintree $*/
	...
	while ($i < count($ModuleLink)){
		...
		if ($_SESSION['ModulesEnabled'][$i]==1)	{
			...
			if ($ModuleLink[$i] == $_SESSION['Module']){
				echo '<tr><td class="main_menu_selected"><a href="' . $_SERVER['SCRIPT_NAME'] . '?Application='. $ModuleLink[$i] . '">' . $ModuleList[$i] . '</a></td></tr>';
			} else {
				echo '<tr><td class="main_menu_unselected"><a href="' . $_SERVER['SCRIPT_NAME'] . '?Application='. $ModuleLink[$i] . '">' . $ModuleList[$i] . '</a></td></tr>';
			}
		}
		$i++;
	}
				...
				<table width="100%">
					...
					<td class="menu_group_items">
						<table width="100%" class="table_index">
                            ...
                            <tr>
							<td class="menu_group_item">
								<b>Inventory Options</b>
							</td>
							</tr>
                             <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/item_master.php">' . _('Item Master') . '</a></p>'; ?>
							</td>
							</tr>
                              <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/purchase_order.php">' . _('Purchase Order') . '</a></p>'; ?>
							</td>
							</tr>
                              <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/add_item.php">' . _('Add Item') . '</a></p>'; ?>
							</td>
							</tr>
                              <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/assign_item.php">' . _('Issue Item ') . '</a></p>'; ?>
							</td>
							</tr>
                              <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/purchase_order_detail.php">' . _('Purchase Order Detail') . '</a></p>'; ?>
							</td>
							</tr>
                              <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/stock_issue_register.php">' . _('Stock Issue Register') . '</a></p>'; ?>
							</td>
							</tr>
                              <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/condemnation.php">' . _('Condemn Item') . '</a></p>'; ?>
							</td>
							</tr>
                              <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/stock_register.php">' . _('Stock Register') . '</a></p>'; ?>
							</td>
							</tr>
                              <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/condemned_items.php">' . _('Condemned Items') . '</a></p>'; ?>
							</td>
							</tr>
                            <tr>
							<td class="menu_group_item">
				...
				<table width="100%">		<!-- Gereral Ledger Option Headings-->
					...
					<td class="menu_group_items"> <!-- General transactions options -->
						<table width="100%" class="table_index">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/CustomerReceipt.php?NewReceipt=Yes&Type=GL">' . _('Bank Account Receipts Entry') . '   (Cash Voucher)</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/GLJournal.php?NewJournal=Yes">' . _('Journal Entry') . '    (Journal Voucher)</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
					...
					<td class="menu_group_items">  <!-- Gereral inquiry options -->
						<table width="100%" class="table_index">
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/GLTrialBalance.php">' . _('Trial Balance With Budget') . ' (Trial Balance)</a></p>'; ?>
							</td>
							</tr>
                            <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/trialbalance.php">' . _('Trial Balance') . ' (Trial Balance)</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/GLAccountInquiry.php">' . _('Account Inquiry') . '</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/GLAccountInquiry.php">' . _('Account Listing') . '</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/DailyBankTransactions.php">' . _('Daily Bank Transactions') . '    (Daily Cash Book)</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
							...
							<td class="menu_group_item">
                             ...
                             <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/dailycashbook.php">' . _('Daily Cash Book') . '</a></p>'; ?>
							</td>
							</tr>
                             <tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/incexp.php">' . _('Income Expenditure') . '</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
					...
					<td class="menu_group_items">  <!-- Gereral Ledger Maintenance options -->
						<table width="100%" class="table_index">
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/GLAccounts.php">' . _('GL Account') . '    (Account Master)</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo '<p>&bull; <a href="' . $rootpath . '/AccountGroups.php">' . _('Account Groups') . '    (Account Group)</a></p>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
