...
/* $Id: StockLocStatus.php 4622 2011-07-03 04:33:19Z daintree $*/
...
echo '<table cellspacing="1" cellpadding="2">
		<tr class="oddrow"><td colspan="2" align="center"><font size="3">Stock Loc Status</font></td></tr>
		
		<tr class="evenrow"><td>' . _('From Stock Location') . ':</td>
...
echo '<tr class="evenrow"><td>' . _('Shown Only Items Where') . ':</td>
...
echo '</td></tr>
<tr class="oddrow"><td colspan="2" align="center"><input type=submit name="ShowStatus" value="' . _('Show Stock Status') . '"></td></tr>
</table><br/>';
