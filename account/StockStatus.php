...
/* $Id: StockStatus.php 4622 2011-07-03 04:33:19Z daintree $*/
...
echo '
<tr class="oddrow"><td colspan="2" align="center"><font size="3">Stock Status</font></td></tr>
<tr class="evenrow"><td>'._('Stock Code') . ':</td><td><input type="text" name="StockID" size="21" value="' . $StockID . '" maxlength="20" /></td></tr>';

echo '<tr class="oddrow"><td colspan="2" align="center"><input type="submit" name="ShowStatus" VALUE="' . _('Show Stock Status') . '" />';
echo'</td></tr></table>';
...
if ($Its_A_KitSet_Assembly_Or_Dummy == True){
	...
	$tableheader = '<tr class="evenrow">
			<td>' . _('Location') . '</td>
			<td>' . _('Quantity On Hand') . '</td>
			<td>' . _('Re-Order Level') . '</td>
			<td>' . _('Demand') . '</td>
			<td>' . _('Available') . '</td>
			<td>' . _('On Order') . '</td>
			</tr>';
