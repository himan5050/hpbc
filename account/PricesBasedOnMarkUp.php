<?php
/* $Revision: 1.9 $ */
/* $Id: PricesBasedOnMarkUp.php 4632 2011-07-16 02:59:14Z daintree $*/
//$PageSecurity=11;
...
echo '<p><table cellspacing="1" cellpadding="2">
             <tr class="oddrow"><td colspan="2" align="center"><h2>Price Based on Makup</h2></td></tr>
			 <tr class="evenrow">
          	   <td colspan="2"> <div class="left">' . _('Select the Price List to update') .':</div>
               <div class="right"><select name="PriceList">';
...
echo '<tr class="oddrow">
        <td colspan="2"> <div class="left">' . _('Select the price list currency to update') . ':</div>
                            <div class="right"><select name="CurrCode">';
...
echo '<tr class="evenrow"><td colspan="2"> <div class="left">' . _('Cost/Preferred Supplier Data Or Other Price List') . ':</div>
                <div class="right"><select name="CostType">';
...
if (isset($_POST['CostType']) and $_POST['CostType']=='OtherPriceList'){
     echo '<tr class="oddrow"><td colspan="2"> <div class="left">' . _('Select the Base Price List to Use') . ':</div>
                            <div class="right"><select name="BasePriceList">';
...
echo '<tr class="oddrow"><td colspan="2"> <div class="left">' . _('Stock Category From') . ':</div>
                <div class="right"><select name="StkCatFrom">';
...
echo '<tr class="evenrow"><td colspan="2"> <div class="left">' . _('Stock Category To') . ':</div>
                <div class="right"><select name="StkCatTo">';
...
echo '<tr class="oddrow"><td colspan="2"> <div class="left">' . _('Rounding Factor') . ':</div>
                <div class="right"><input type="text" class=number name="RoundingFactor" size="6" maxlength="6" value=' . $_POST['RoundingFactor'] . '></div></td></tr>';

echo '<tr class="evenrow"><td colspan="2"> <div class="left">' . _('New Price To Be Effective From') . ':</div>
                <div class="right"><input type="text" class=date alt="' . $_SESSION['DefaultDateFormat'] . '" name="PriceStartDate" size="10" maxlength="10" value="' . $_POST['PriceStartDate'] . '"></div></td></tr>';

echo '<tr class="oddrow"><td colspan="2"> <div class="left">' . _('New Price To Be Effective To (Blank = No End Date)') . ':</div>
                <div class="right"><input type="text" class=date alt="' . $_SESSION['DefaultDateFormat'] . '" name="PriceEndDate" size="10" maxlength="10" value="' . $_POST['PriceEndDate'] . '"></div></td></tr>';

if (!isset($_POST['IncreasePercent'])){
	$_POST['IncreasePercent']=0;
}

echo '<tr class="evenrow"><td colspan="2"> <div class="left">' . _('Percentage Increase (positive) or decrease (negative)') . '</div>
                <div class="right"><input type="text" name="IncreasePercent" class=number size=4 maxlength=4 VALUE="' . $_POST['IncreasePercent'] . '"></div></td></tr>
				<tr class="oddrow"><td colspan="2" align="center"><input type=submit name="UpdatePrices" VALUE="' . _('Update Prices') . '"\'  onclick="return confirm(\'' . _('Are you sure you wish to update or add all the prices according to the criteria selected?') . '\');"></td></tr>
				</table>';
