...
/* $Id: InventoryPlanningPrefSupplier.php 4635 2011-07-19 09:35:25Z daintree $ */
...
// Also need to add in the demand as a component of an assembly items if this items has any assembly parents.
    ...
    echo'<tr class="oddrow"><td colspan="2" align="center"><font size="3">Inventory Planning Pref Supplier</font></tr></td>';
	...
	echo '<tr class="oddrow"><td>' . _('Months Buffer Stock to Hold') . ':</td>
	...
	echo '</select></td></tr>';
    echo'<tr class="evenrow"><td colspan="2" align="center"><input type="submit" name="PrintPDF" value="' . _('Print PDF') . '"></td></tr>';
	echo '</table>
			<br />
			';
