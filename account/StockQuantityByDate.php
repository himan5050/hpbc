...
/* $Id: StockQuantityByDate.php 4622 2011-07-03 04:33:19Z daintree $ */
...
<tr class="oddrow"><td colspan="2" align="center"><font size="3">Stock Quantity By Date</font></td></tr>
<tr class="evenrow">';
...
echo '</select></td></tr><tr class="oddrow">';
...
echo '</tr><tr class="evenrow"><td>' . _('On-Hand On Date') . ':</td>
...
echo '<tr class="oddrow"><td colspan="2" align="center"><input type=submit name="ShowStatus" value="' . _('Show Stock Status') .'"></td></tr></table>';
echo '</form>';
