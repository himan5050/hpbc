...
/* $Id: SalesCategories.php 4638 2011-07-26 09:21:52Z daintree $ */
...
if (DB_num_rows($result) == 0) {
	...
	<tr class="oddrow"><td colspan="5" align="center"><font size="3">Seles Categories</font></td></td>
	
	';
	echo '<tr class="evenrow"><td colspan="5" align="center">' . _('Sub Category') . '</td></tr>';
...
echo '<tr class="evenrow"><td colspan="2" align="center">' . $FormCaps . '</td></tr>';
echo '<tr class="oddrow" style="height:40px;"><td>' . _('Category Name') . ':</td>
...
if($result && DB_num_rows($result)) {
	...
	echo '';
	echo '<table cellspacing="1" celpadding="2">';
	echo '<tr class="evenrow"><td colspan="2" align="center">'._('Add Inventory to this category').'</td></tr>';
	echo '<tr class="oddrow"><td>' . _('Select Inv. Item') . ':</td><td>';
	...
	echo '</select>';
	echo '</td></tr>
	<tr class="evenrow"><td colspan="5" align="center" >
	<input type="submit" name="submit" value="' . _('Add Inventory Item') . '">
	</td></tr>
	</table>';
...
if($result ) {
	if( DB_num_rows($result)) {
		...
		echo '<tr class="evenrow"><td colspan="3" align="center">'._('Inventory items in this category').'</td></tr>';
		echo '<tr class="oddrow"><td  >' . _('Stock Code') . '</td>';
		echo '<td colspan="2" align="center">' . _('Description') . '</td></tr>';
		...
		while( $myrow = DB_fetch_array($result) ) {
			...
			echo '<td class="normal">' . $myrow['stockid'] . '</td>';
			echo '<td class="normal">' . $myrow['description'] . '</td>';
