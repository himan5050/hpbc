...
$output .='<table><tr><td align="left"><table cellpadding="2" cellspacing="2" border="0" class="header4_2">
			<tr>
		   		<td width="12%" class="header4_2"><b>Loan Amount:</b></td>	
				<td width="15%" class="header4_2">'.$loan_amount.'</td>								
		   	</tr>
			<tr>
		   		<td class="header4_2"><b>Interest Rate:</b></td>
				<td class="header4_2">'.$interest.'</td>									
		   	</tr>
			<tr>
		   		<td class="header4_2"><b>Subsidy Amount:</b></td>
				<td class="header4_2">'.$subsidy.'</td>									
		   	</tr>
			<tr>
		   		<td class="header4_2"><b>Tenure:</b></td>
				<td class="header4_2">'.$tenuare.'</td>									
		   	</tr>			
		   </table></td>
';	

$output .='<td><table cellpadding="2" cellspacing="2" border="0" class="header4_2" width="265%">
			<tr>
		   	    <td width="12%" class="header4_2"><b>Interest:</b></td>
				<td width="15%" class="header4_2">'.$interestfinal.'</td>									
		   	</tr>
			<tr>
		   		<td class="header4_2"><b>Total Amount:</b></td>
				<td class="header4_2">'.$totalp.'</td>									
		   	</tr>			
