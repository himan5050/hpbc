...
<tr><td class="header1"><b>Item Code :</b> '. $_REQUEST['itemcode'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>From Date :</b> '. date('d-m-Y',$from).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>To Date :</b> '.date('d-m-Y',$to).'</td></tr>
</table><br />';
...
<td class="header2">Name of person who has verified the item physically</td>
	...
	{ $counter=1;
	  ...
	  {   if($counter%2==0){ $class='header4_1';}else{$class='header4_2';}
		...
		<td class="'.$class.'" align="right">'.round(abs(($r->quantity * $r->itemrate))).'</td>
		<td class="'.$class.'" align="right">'.$r->openingval.'</td>
		<td class="'.$class.'" align="right">'.round(abs($r->openingval*$r->itemrate)).'</td>
