...
{ 
 ...
 $output.='<tr><td style="border-top-color:#ccc; border-top:1px solid;"></td><td style="border-top-color:#ccc; border-top:1px solid;"><b>Total:</b></td><td style="border-top-color:#ccc; border-top:1px solid;"><b><i>'.round(array_sum($totaldebit),2).'</i></b></td><td style="border-top-color:#ccc; border-top:1px solid;"><b><i>'.round(array_sum($totalcredit),2).'</i></b></td></tr>';
 $output.='</table><br />';
...
$data ='<table class="tbl_border" cellpadding="3" cellspacing="2"><tr><td colspan="3" align="center" class="header2"><h2>Income</h2></td></tr>';
$data .='<tr><td><b>Code</b></td><td><b>A/C</b></td><td><b>Income</b></td></tr>';
...
if($qr['amount']>0)
{
  $debtotal=$debtotal+$qr['amount'];
	...
	$data .= '<tr>
  				<td class="'.$cla.'">'.$qr['accountcode'].'</td>
				<td class="'.$cla.'">'.ucwords($qr['accountname']).'</td>
				<td class="'.$cla.'">'.$qr['amount'].'</td>
		  </tr>';
     }
	  $f++;
   }
...
$acce=array();
$accounte=array();
$datae ='<table class="tbl_border" cellpadding="3" cellspacing="2"><tr><td colspan="3" align="center" class="header2"><h2>Expenditure</h2></td></tr>';
$datae .='<tr><td><b>Code</b></td><td><b>A/C</b></td><td><b>Expenditure</b></td></tr>';
...
if($qre['amount']<0)
{
  $debtotale=$debtotale+$qre['amount'];
	...
	$datae .= '<tr>
  				<td class="'.$cla.'">'.$qre['accountcode'].'</td>
				<td class="'.$cla.'">'.ucwords($qre['accountname']).'</td>
				<td class="'.$cla.'">'.$qre['amount'].'</td>
		  </tr>';
     }
	 $f++;
   }
...
$datae .= '<tr><td>Total</td><td>&nbsp;</td>
				<td>'.round($debtotale,2).'</td></tr>';
$datae .='</table>';

 //$datae;
 
  $output .='<table><tr><td><div>'.$data.'</div></td><td><div >'.$datae.'</div></td></tr></table>';
...
$bank=array();
 ...
 $opbr=db_fetch_array($opbq);
  ...
  $s="SELECT banktrans.ref, gltrans.account, banktrans.banktranstype, banktrans.amount as bamount, banktrans.transno, gltrans.chequeno,chartmaster.accountname
...
<tr><td class="header2" width="8%">Voucher No.</td><td class="header2" width="8%">A/C Code</td><td class="header2" width="10%">A/C Head</td><td class="header2" width="8%">Particulars</td><td class="header2" width="8%">Cash Amount</td><td class="header2" width="8%">Bank Amount</td><td class="header2" width="7%">Voucher No.</td><td class="header2" width="7%">A/C Code</td><td class="header2" width="10%">A/C Head</td><td class="header2" width="8%">Particulars</td><td class="header2" width="8%">Cash Amount</td><td class="header2" width="10%">Bank Amount</td></tr>';		
	...
	//echo $r['account'];
	  ...
	  { // echo "test";
	    ...
	    $output .='<tr ><td class="'.$cl.'">'.$r["chequeno"].'</td><td class="'.$cl.'">'.$r['account'].'</td><td class="'.$cl.'">'.$r["accountname"].'</td><td class="'.$cl.'">'.$r["ref"].'</td><td class="'.$cl.'">'.$cash.'</td><td class="'.$cl.'">'.$cheque.'</td><td class="'.$cl.'">--</td><td class="'.$cl.'">--</td><td class="'.$cl.'">--</td><td class="'.$cl.'">--</td><td class="'.$cl.'">--</td><td class="'.$cl.'">--</td></tr>';
		}
		else if($r['bamount']<0)
	  {
	     if($r['banktranstype']=='Cash')
	    ...
	    $output .='<tr><td class="'.$cl.'">--</td><td class="'.$cl.'">--</td><td class="'.$cl.'">--</td><td class="'.$cl.'">--</td><td class="'.$cl.'">--</td><td class="'.$cl.'">--</td><td class="'.$cl.'">'.$r["chequeno"].'</td><td class="'.$cl.'">'.$r['account'].'</td><td class="'.$cl.'">'.$r["accountname"].'</td><td class="'.$cl.'">'.$r["ref"].'</td><td class="'.$cl.'">'.$cash.'</td><td class="'.$cl.'">'.$cheque.'</td></tr>';
		}
	}	
	$nn++;
	}
...
$output .=' <table class="tbl_border" cellspacing="2" cellpadding="3">
	  <tr><td width="10%" class="header2"><b>Audit Date</b></td><td width="10%" class="header2"><b>Office Name</b></td><td width="10%" class="header2"><b>Section Name</b></td><td width="10%" class="header2"><b>Auditor</b></td><td width="10%" class="header2"><b>Remark</b></td><td width="12%" class="header2"><b>NCs</b></td><td width="8%" class="header2"><b>Description</b></td><td width="10%" class="header2"><b>Severity</b></td><td width="10%" class="header2"><b>Clause</b></td><td width="7%" class="header2"><b>Action Taken</b></td></tr>';
 ...
 $s="select * from audit_detail where auditdate>='".$from."' and auditdate<='".$to."' and auditoffice='".$office."' order by auditdate";
	  ...
	  {  if($k%2==0)
	   ...
	   $ncq=db_query($nc,$db);
	  $nctd ='<table style="border:none;" cellpadding="3" cellspacing="2">';
	  
	   while($ncr=db_fetch_array($ncq))
	   {
	     
	     $nctd .='<tr ><td width="12%" style="border:none;" class="'.$cl.'"><div style="word-wrap:break-word; width:60px;">'.$ncr['nsc'].'</div></td><td width="8%" style="border:none;" class="'.$cl.'"><div style="word-wrap:break-word; width:60px;">'.$ncr['description'].'</div></td><td width="10%" style="border:none;" class="'.$cl.'"><div style="word-wrap:break-word; width:60px;">'.$ncr['sevirity'].'</div></td><td width="9.5%" style="border:none;" class="'.$cl.'"><div style="word-wrap:break-word; width:60px;">'.$ncr['clause'].'</div></td><td width="7%" style="border:none;" class="'.$cl.'"><div style="word-wrap:break-word; width:60px;" >'.$ncr['corrective_report'].'</div></td></tr>';
		 
	   }
	   $nctd.='</table>';
	   
	   
	   $output .='<tr><td valign="top" width="10%" class="'.$cl.'" align="center">'.date('d-m-Y',$r['auditdate']).'</td><td valign="top" width="10%" class="'.$cl.'">'.$r2['corporation_name'].'</td><td valign="top" width="10%" class="'.$cl.'">'.$r['section'].'</td><td valign="top" width="10%" class="'.$cl.'">'.$r1['name'].'</td><td width="10%" valign="top" class="'.$cl.'">'.$r['remark'].'</td><td colspan="5" width="10%" class="'.$cl.'">'.$nctd.'</td></tr>';
	   	$k++;	   
	  }
	$output .='</table>';
...
$output .='<table cellpadding="0" cellspacing="0" border="0">
<tr><td class="header_report" colspan="5" align="center">
Bank Reconcillation Report</td></tr></table>';
...
//$pdf->writeHTML($output, true, 0, true, true);
	...
	$output .='<table class="tbl_border" cellspacing="2" cellpadding="3">
			<tr class="even"><td><b>'.$BankAccountName;
			
	/*if ($_SESSION['CompanyRecord']['currencydefault']!=$BankCurrCode){
		echo  ' (' . $BankCurrCode . ' @ ' . $ExRate .')';
	}*/
	$output .='</b></td>
			<td><b>'.number_format($Balance*$ExRate,$CurrDecimalPlaces).'</b></td></tr>';
 ...
 $SQL = "SELECT amount/exrate AS amt,
	...
	$output .='<tr class="oddrow"><td><b>Add back unpresented cheques:</b></td></tr>';

	$TableHeader = '<tr>
				    <td width="12%" class="header2">Date</td>
					<td width="12%" class="header2">Type</td>
					<td width="12%" class="header2">Number</td>
					<td width="12%" class="header2">Reference</td>
					<td width="12%" class="header2">Orig Amount</td>
					<td width="12%" class="header2">Outstanding</td>
					</tr>';
...
$DisplayTranDate=$DisplayTranDat[2]."-".$DisplayTranDat[1]."-".$DisplayTranDat[0];
		$output .='<tr><td class="'.$cla.'">'.$DisplayTranDate.'</td>
				<td width="12%" class="'.$cla.'">'.$myrow1['typename'].'</td>
				<td width="12%" class="'.$cla.'">'.$myrow1['transno'].'</td>
				<td width="12%" class="'.$cla.'">'.$myrow1['ref'].'</td>
				<td width="12%" class="'.$cla.'">'.number_format($myrow1['amt'],$CurrDecimalPlaces).'</td>
				<td width="12%" class="'.$cla.'">'.number_format($myrow1['outstanding'],$CurrDecimalPlaces).'</td>
				</tr>';
	...
	//end of while loop
	$output .='<tr class="even"><td><b>Total of all unpresented cheques</b></td><td align="right">' . number_format($TotalUnpresentedCheques,$CurrDecimalPlaces) . '</td></tr>';
	...
	$output .='<tr class="oddrow"><td><b>Less deposits not cleared:</b></td></tr>';
	...
	else
	{
	  $cla="header4_2";
		...
		$output .='<tr><td align="center"  class="'.$cla.'">'.$DisplayTranDate.'</td>
				<td width="12%" class="'.$cla.'" >'.$myrow['typename'].'</td>
				<td width="12%" class="'.$cla.'">'.$myrow['transno'].'</td>
				<td width="12%" class="'.$cla.'">'.$myrow['ref'].'</td>
				<td width="12%" class="'.$cla.'">'.number_format($myrow['amt'],$CurrDecimalPlaces).'</td>
				<td width="12%" class="'.$cla.'">'.number_format($myrow['outstanding'],$CurrDecimalPlaces).'</td>
				</tr>' ;
	...
	$output .='<tr></tr>
			<tr class="even">
				<td><b>Total of all uncleared deposits</b></td>
				<td align="right">' . number_format($TotalUnclearedDeposits,$CurrDecimalPlaces) . '</td>
			</tr>';
	...
	$output .='<tr></tr>
			<tr class="oddrow">
				<td><b>Bank statement balance should be(INR)</b></td>
				<td align="right">' . number_format($FXStatementBalance,$CurrDecimalPlaces) . '</td></tr>';

 
  $output .='</table><table><tr><td><div>'.$data.'</div></td><td><div >'.$datae.'</div></td></tr></table>';
...
$output .=' <table class="tbl_border" cellspacing="2" cellpadding="3" style="width:2250px;">
 ...
 $s="select * from audit_detail where auditdate>='".$from."' and auditdate<='".$to."' and auditoffice='".$office."' order by auditdate";
	  ...
	  {  if($k%2==0)
	   ...
	   $output .='<tr><td valign="top" width="3%" class="'.$cl.'" align="center">'.$k.'</td><td valign="top" width="10%" class="'.$cl.'">'.ucwords($r2['corporation_name']).'</td><td valign="top" width="10%" class="'.$cl.'">'.ucwords($r1['name']).'</td><td valign="top" width="10%" class="'.$cl.'" align="center">'.date('d-m-Y',$r['auditdate']).'</td><td valign="top" width="10%" class="'.$cl.'">'.$r3['period'].'</td></tr>';
	   	$k++;	   
	  }
	$output .='</table>';
		...
		if ($myrow['groupname']!= $ActGrp ){
			if ($ActGrp !=''){ //so its not the first account group of the first account displayed
				if ($myrow['parentgroupname']==$ActGrp){
					...
					$output .='<tr>
						<td colspan="2"><I>'.$ParentGroups[$Level].' Total </I></td>
						<td ><I>'.number_format($GrpActual[$Level],$_SESSION['CompanyRecord']['decimalplaces']).'</I></td>
						<td ><I>'.number_format($GrpBudget[$Level],$_SESSION['CompanyRecord']['decimalplaces']).'</I></td>
						<td ><I>'.number_format($GrpPrdActual[$Level],$_SESSION['CompanyRecord']['decimalplaces']).'</I></td>
						<td ><I>'.number_format($GrpPrdBudget[$Level],$_SESSION['CompanyRecord']['decimalplaces']).'</I></td>
						</tr>';
...
if($j%2==0)
	...
	else
	{
	 $cl="header4_2";
		...
		$output .='<tr><td class="'.$cl.'">'.$ActEnquiryURL.'</td>
			...
			<td class="'.$cl.'">'.number_format($myrow['monthactual'],$_SESSION['CompanyRecord']['decimalplaces']).'</td>
			<td class="'.$cl.'">'.number_format($myrow['monthbudget'],$_SESSION['CompanyRecord']['decimalplaces']).'</td>
			<td class="'.$cl.'">'.number_format($AccountPeriodActual,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
			<td class="'.$cl.'">'.number_format($AccountPeriodBudget,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
			</tr>';
	...
	$output .='<tr bgcolor="#ffffff">
			...
			<td class="header2">'.number_format($CheckMonth,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
			<td class="header2">'.number_format($CheckBudgetMonth,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
			<td class="header2">'.number_format($CheckPeriodActual,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
			<td class="header2">'.number_format($CheckPeriodBudget,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
		</tr>';
...
//	echo '<div class="breadcrumb">Home &raquo; <a href="'.$_SERVER['PHP_SELF'].'">Balance Sheet</a></div>';
   $bald=explode('-',$BalanceDate);
	...
	while ($myrow['groupname']!=$ParentGroups[$Level] AND $Level>0){
		...
		$output .='<tr><td colspan="2"><I>'.$ParentGroups[$Level].'</I></td>
			<td >'.number_format($GroupTotal[$Level]).'</td>
			<td></td>
			<td >'.number_format($LYGroupTotal[$Level]).'</td>
			</tr>';
...
Profit Loss Report</td></tr>
	...
	$output .='<b><p class="page_title_text">Statement of Profit and Loss for the' . $NumberOfMonths . 'months to and including '. $PeriodToDate . '</p></b>';
	...
	while ($myrow=db_fetch_array($AccountsResult)) {
			...
			if ($myrow['parentgroupname']!=$ActGrp AND $ActGrp!=''){
				...
				if ($Section ==1){ /*Income */
						$output .='<tr>
								...
								<td></td>
								<td >'.number_format(-$GrpPrdActual[$Level],$_SESSION['CompanyRecord']['decimalplaces']).'</td>
								<td></td>
								<td >'.number_format(-$GrpPrdBudget[$Level],$_SESSION['CompanyRecord']['decimalplaces']).'</td>
								<td></td>
								<td >'.number_format(-$GrpPrdLY[$Level],$_SESSION['CompanyRecord']['decimalplaces']).'</td>
								</tr>';
					} else { /*Costs */
						$output .='<tr>
								<td colspan="2"><I>'.$ActGrpLabel.'</I></td>
		...
		if ($myrow['sectioninaccounts']!= $Section){
			...
			if ($SectionPrdLY+$SectionPrdActual+$SectionPrdBudget !=0){
				if ($Section==1) { /*Income*/
					...
					$output .='<tr>
							...
							<td></td>
							<td >'.number_format(-$SectionPrdActual,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
							<td></td>
							<td >'.number_format(-$SectionPrdBudget,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
							<td></td>
							<td >'.number_format(-$SectionPrdLY,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
							</tr>';
				...
				if ($Section==2){ /*Cost of Sales - need sub total for Gross Profit*/
					...
					$output .='<tr>
							...
							<td></td>
							<td >'.number_format($TotalIncome - $SectionPrdActual,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
							<td></td>
							<td >'.number_format($TotalBudgetIncome - $SectionPrdBudget,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
							<td></td>
							<td >'.number_format($TotalLYIncome - $SectionPrdLY,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
							</tr>';
					...
					$output .='<tr>
							<td colspan="2"><I>Gross Profit Percent</I></td>
							<td></td>
							<td ><I>'.number_format($PrdGPPercent,1) . '%</I></td>
							<td></td>
							<td ><I>'.number_format($BudgetGPPercent,1) . '%</I></td>
							<td></td>
							<td ><I>'.number_format($LYGPPercent,1). '%</I></td>
			...
			if ($_REQUEST['Detail']=='Detailed'){
				$output .='<tr>
					<td colspan="8" align="center"><b>'.$Sections[$myrow['sectioninaccounts']].'</b></td>
					</tr>';
			}
			$j++;
		  ...
		  // $cla="header4_2";
			...
			if ($Section ==1){
				 $output .='<tr><td class="'.$cla.'">'.$ActEnquiryURL.'</td>
						<td class="'.$cla.'">'.$myrow['accountname'].'</td>
						<td class="'.$cla.'"></td>
						<td class="'.$cla.'">'.number_format(-$AccountPeriodActual,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
						<td class="'.$cla.'"></td>
						<td class="'.$cla.'">'.number_format(-$AccountPeriodBudget,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
						<td class="'.$cla.'"></td>
						<td class="'.$cla.'">'.number_format(-$AccountPeriodLY,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
						</tr>';
			} else {
				$output .='<tr><td class="'.$cla.'">'.$ActEnquiryURL.'</td>
						<td class="'.$cla.'">'.$myrow['accountname'].'</td>
	...
	$output .='<tr bgcolor="#ffffff">
			...
			<td></td>
			<td >'.number_format(-$PeriodProfitLoss,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
			<td></td>
			<td >'.number_format(-$PeriodBudgetProfitLoss,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
			<td></td>
			<td >'.number_format(-$PeriodLYProfitLoss,$_SESSION['CompanyRecord']['decimalplaces']).'</td>
			</tr>';
	...
	$output .='<tr>
			<td colspan="2"><I>Net Profit Percent</I></td>
			<td></td>
			<td><I>'.number_format($PrdNPPercent,1) . '%</I></td>
			<td></td>
			<td><I>'.number_format($BudgetNPPercent,1) . '%</I></td>
			<td></td>
			<td ><I>'.number_format($LYNPPercent,1). '%</I></td>
