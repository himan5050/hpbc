...
<td width="8%" colspan="1" align="center" class="header2">Dispatch Number</td>
...
$opening= $ssamt->amount-$bbamt->amount;
	//echo $opening;
	$open=$opening;}
   $output .='<tr> <td colspan="11" align="left"><b>Opening Balance = '.$opening.'</b></td></tr>';
...
$open=$ballu;
 $section=getLookupName($rs->sender_details);
   if($counter%2==0){ $class='header4_1';}else{$class='header4_2';}
				...
				<td width="8%" class="'.$class.'" align="right">'.$rs->amount.'</td>
				<td width="8%" class="'.$class.'" align="right">'.$ballu.'</td>
