...
<tr><td class="header_report" style="text-align:center;" colspan="6">RTI Report</td><td></td></tr></table><br />';
...
<tr><td class="header1" align="left"><b>Sections : </b>'.ucwords($section).'</td></tr>
</table><br />';
	}
 ...
 while($rs = db_fetch_object($res)){
  $sd= date('d-m-Y',strtotime($rs->datecurrent));
   ...
   if($counter%2==0){ $class='header4_1';}else{$class='header4_2';}
				...
				<td width="8%" class="'.$class.'" align="left">'.ucwords($rs->section).'</td>
				...
				<td width="8%" class="'.$class.'" align="left">'.$rs->application_category.'</td>
