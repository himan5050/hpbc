...
<td width="8%" class="header2">Registration No.</td>
...
$prince=round($rs->amount,2); if($prince==''){$prince='N/A';}
   ...
   if($counter%2==0){ $class='header4_1';}else{$class='header4_2';}
				...
				<td width="8%" class="'.$class.'" align="left">'.$regnoo.'</td>

				<td width="9%" class="'.$class.'" align="center">'.date('d-m-Y',strtotime($rs->fdr_date)).'</td>
			    <td width="7%" class="'.$class.'" align="right">'.round($prince).'</td>
				...
				<td width="10%" class="'.$class.'" align="right">'.round($rs->maturity_amount).'</td>
