...
//$pdf->SetHeaderData('tcpdf/images/hpsc.png', PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE, PDF_HEADER_STRING);<br />
...
$output .='<tr><td colspan="0" align="center" class="header_report">Loan Disbursement Report</td></tr><tr><td>&nbsp;</td></tr>
					   ...
					   <td class="'.$class.'">'.ucwords($rs->schemename).'</td>
					    <td class="'.$class.'">'.$accno.'</td>
						 <td class="'.$class.'">'.ucwords($rs->fname).'&nbsp;'.ucwords($rs->lname).'</td>
						  ...
						  <td class="'.$class.'" align="right">'.round($rs->loan_amount).'</td>
