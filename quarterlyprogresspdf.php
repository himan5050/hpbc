...
<tr><td class="header_report" align="center">Quarterly Progress Report in respect of District - '.ucwords($d->district_name).' </td></tr></table><br />';
		...
		while($r = db_fetch_object($res))
		{
			...
			$output .= '<tr>';
			$output .= '<td align="right" class="'.$cl.'">'.$counter.'</td><td align="left" class="'.$cl.'">'.ucwords($r->fname.' '.$r->lname).'</td><td align="left" class="'.$cl.'">'.ucwords($r->scheme).'</td><td align="right" class="'.$cl.'">'.round($r->loan_requirement).'</td>';

			$output .= '<td align="right" class="'.$cl.'">'.round($oamt->outprin).'</td><td align="right" class="'.$cl.'">'.round($oamt->outint).'</td><td align="right" class="'.$cl.'">'.round($oldamt->outld).'</td><td align="right" class="'.$cl.'">'.round($ctotaloutstanding_amt).'</td><td align="right" class="'.$cl.'">-</td>';
			...
			$output .= '<td align="right" class="'.$cl.'">'.round($overdueprin).'</td><td align="right" class="'.$cl.'">'.round($overdueint).'</td><td align="right" class="'.$cl.'">'.$overdueld.'</td>';
			...
			$output .= '<td align="right" class="'.$cl.'">'.round($cdemand->outprin).'</td><td align="right" class="'.$cl.'">'.round($cdemand->outint).'</td><td class="'.$cl.'">'.round($oldamt->outld).'</td><td align="right" class="'.$cl.'">'.round($totaldemand_amt).'</td>';
			...
			$output .= '<td align="right" class="'.$cl.'">'.round($outat_end_of_quarter_prin).'</td><td align="right" class="'.$cl.'">'.round($outat_end_of_quarter_int).'</td><td align="right" class="'.$cl.'">'.round($outat_end_of_quarter_ld).'</td><td align="right" class="'.$cl.'">'.round($grandtotaloutstanding).'</td><td align="right" class="'.$cl.'">-</td>';
			$output .= '</tr>';
		} 
		$output .= '</table>';
	ob_end_clean();
