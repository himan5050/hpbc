...
//http://www.citytree.be/blog/destroy-session-when-closing-browser
/**
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_hpbc_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_hpbc_dd.inc';
}
// </DDSETTINGS>
