...
<td width="10%" colspan="1"  class="header2">Section</td>
<td width="10%" colspan="1"  class="header2">Asset Type</td>
<td width="8%" colspan="1"  class="header2">Quantity</td>
<td width="9%" colspan="1"  class="header2">Amount</td>
<td width="7%" colspan="1"  class="header2">Procurement Cost</td>
...
<td width="9%" colspan="1"  class="header2">Claim Details</td>
...
<td width="9%" colspan="1"  class="header2">Contract Details</td>
 ...
 while($rs = db_fetch_object($res)){
   ...
   if($counter%2==0){ $class='header4_1';}else{$class='header4_2';}
				...
				<td width="10%" class="'.$class.'" align="left">'.ucwords(getCorporationName($rs->section)).'</td>
				<td width="10%" class="'.$class.'" align="left">'.ucwords($rs->asset_type).'</td>
				<td width="8%" class="'.$class.'" align="left">'.ucwords($rs->quantity).'</td>

				<td width="9%" class="'.$class.'" align="center">'.$rs->amount.'</td>
			    <td width="7%" class="'.$class.'" align="right">'.$rs->proc_cost.'</td>
				<td width="9%" class="'.$class.'" align="center">'.ucwords($rs->asset_details).'</td>
								<td width="9%" class="'.$class.'" align="center">'.ucwords($rs->company_name).'</td>
				<td width="9%" class="'.$class.'" align="center">'.ucwords($rs->sum_insured).'</td>
				<td width="9%" class="'.$class.'" align="center">'.ucwords($rs->date_renewal).'</td>
				<td width="9%" class="'.$class.'" align="center">'.ucwords($rs->claim_details).'</td>
				<td width="9%" class="'.$class.'" align="center">'.ucwords($rs->vendor_name).'</td>
				<td width="9%" class="'.$class.'" align="center">'.date('d-m-Y',strtotime($rs->date_amc)).'</td>
				<td width="9%" class="'.$class.'" align="center">'.$rs->amount_amc.'</td>
				<td width="9%" class="'.$class.'" align="center">'.ucwords($rs->contract_details).'</td>
