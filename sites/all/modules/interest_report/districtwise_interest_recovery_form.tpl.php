<head>
    <?php
    global $base_url;
    $css_path = $base_url . '/' . drupal_get_path('module', 'interest_report') . "/form_style.css";
    ?>
...
<div id="rec_participant">
    <table width="100%" cellpadding="2" cellspacing="0" border="0" id="wrapper">
        <tr><td align="left" class="tdform-width"><fieldset><legend>District-wise Interest and Recovery Summary Report:</legend>
...
if ($op == 'Generate Report') {
    ...
    print_r($from_date.' and '.$to_date); exit;
