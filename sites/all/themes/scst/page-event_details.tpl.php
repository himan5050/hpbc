...
?>
   ...
   <div id="main-content-home">  
          ...
          <?php
		  if($language->language == 'hi'){
			$sql = "select * from node where type='event' and language ='hi' order by changed desc";
			echo '<ul>';
			$res = db_query($sql);
		 ...
		 $sql = "select * from node where type='event' and language ='en' order by changed desc";
			echo '<ul>';
			$res = db_query($sql);
			while($rs = db_fetch_object($res)){
			  $nodeb =node_load($rs->nid);
