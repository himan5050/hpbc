...
$pendingcommentsql = "SELECT COUNT(*) as comment,workflow_name,comment_url FROM tbl_loan_comment lc, tbl_workflow_docket wd, tbl_workflow w WHERE lc.doc_id = wd.doc_id AND wd.workflow_id = w.workflow_id  AND FIND_IN_SET(lc.commentedto,'".$roles."') AND lc.status = 0 $conditionstr GROUP BY w.workflow_name"; 
...
echo "<tr>
			<td valign='top' width='33%'>".$bl1."</td>
			<td valign='top' width='33%'>".$bl2."</td>
			<td valign='top' width='33%'>".$bl3."</td>
</tr>
</table>";
?>
