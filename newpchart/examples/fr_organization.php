<?php   
 ...
 $MyData = new pData();   
 $MyData->addPoints(array($_GET['Invoices_sent'],$_GET['payment_received']),"ScoreA");  
 $MyData->setSerieDescription("Application A","ScoreA");

 /* Define the absissa serie */
 $MyData->addPoints(array("Trained Organization(".$_GET['Invoices_sent'].")","Remaining to be trained(".$_GET['payment_received'].")"),"Labels");
 ...
 $myPicture->setFontProperties(array("FontName"=>"../fonts/Silkscreen.ttf","FontSize"=>9));
...
// $myPicture->drawText(440,200,"",array("DrawBox"=>TRUE,"BoxRounded"=>TRUE,"R"=>0,"G"=>0,"B"=>0,"Align"=>TEXT_ALIGN_TOPMIDDLE));
 ...
 $PieChart->drawPieLegend(60,8,array("Style"=>LEGEND_NOBORDER,"Mode"=>LEGEND_HORIZONTAL));
