<?php   
 ...
 //Invoices_sent='.$countinvoice.'&payment_received='.$countinvoice.'&filename='.$filename.
 $receive = $_GET['Invoices_sent']-$_GET['payment_received'];
 /* Create and populate the pData object */
 $MyData = new pData();   
 $MyData->addPoints(array($receive,$_GET['payment_received']),"ScoreA");  
 $MyData->setSerieDescription("ScoreA","Application A");

 /* Define the absissa serie */
 $MyData->addPoints(array("BILL/INVOICE Genereted(".$_GET['Invoices_sent'].") ( Payment Received ".$receive.")","Payment Pending(".$_GET['payment_received'].")"),"Labels");
...
*/
 ...
 $myPicture->drawRectangle(0,0,650,229,array("R"=>0,"G"=>0,"B"=>0));
...
// $myPicture->setFontProperties(array("FontName"=>"../fonts/Forgotte.ttf","FontSize"=>10,"R"=>0,"G"=>0,"B"=>0));
 ...
 $PieChart->draw3DPie(290,125,array("WriteValues"=>TRUE,"DataGapAngle"=>10,"DataGapRadius"=>6,"Border"=>TRUE));
...
// $myPicture->drawText(440,200,"",array("DrawBox"=>TRUE,"BoxRounded"=>TRUE,"R"=>0,"G"=>0,"B"=>0,"Align"=>TEXT_ALIGN_TOPMIDDLE));
