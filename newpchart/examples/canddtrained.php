<?php   
 ...
 $MyData->addPoints(array($_GET['Total_Potential_Franchisee'],$_GET['Total_Trained_Potential_Franchisee']),'');
 $MyData->setAxisName(0,"No Of Participant");
 $MyData->addPoints(array("Total Participants","Total Trained Participants"),"Months");
 ...
 /* Draw the chart */
 $settings = array("Gradient"=>TRUE,"GradientMode"=>GRADIENT_EFFECT_CAN,"DisplayPos"=>LABEL_POS_INSIDE,"DisplayValues"=>TRUE,"DisplayR"=>255,"DisplayG"=>12,"DisplayB"=>255,"DisplayShadow"=>TRUE,"Surrounding"=>10);
