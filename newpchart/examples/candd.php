<?php   
 ...
 $MyData->addPoints(array($_REQUEST['total'],$_REQUEST['c'],$_REQUEST['d']),'');
 $MyData->setAxisName(0,"No. of Employees");
 $MyData->addPoints(array("Total Employees","Total No. of C Employees","Total No. of D Employees"),"Months");
