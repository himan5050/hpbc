<?php   
 ...
 $MyData = new pData();  
 $MyData->addPoints(explode(',',$_GET['programStr']),"Total Program");
 $MyData->addPoints(explode(',',$_GET['totalMenDaysStr']),"Man Days"); 

 $MyData->setSerieTicks("Probe 2",4);
 $MyData->setSerieWeight("Probe 3",2);
 $MyData->setAxisName(0,"No. of Participant");
 $MyData->addPoints(explode(',',$_GET['periodStr']),"Labels"); 
...
// $myPicture->drawText(10,13,"drawPlotChart() - draw a plot chart",array("R"=>255,"G"=>255,"B"=>255));
 ...
 $myPicture->drawLegend(170,220,array("Style"=>LEGEND_NOBORDER,"Mode"=>LEGEND_HORIZONTAL));
