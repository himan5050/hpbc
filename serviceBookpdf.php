...
if($rs->pincode!=''){
$output .='<tr ><td></td><td align="left" ><b>Permanent Home Address:</b></td><td  align="left" ><div style="width:50px;">'.ucwords($rs->add_line1).', '.ucwords($rs->add_line2).', '.ucwords($rs->panchayat).','.ucwords($rs->block).',  '.ucwords($gettehsil->tehsil_name).', '.ucwords($getdistrict->district_name).', '.ucwords($getstate->state_name).', '.$rs->pincode.'</div></td></tr>';
}else{
$output .='<tr ><td></td><td align="left" ><b>Permanent Home Address:</b></td><td  align="left" ><div style="width:50px;">'.ucwords($rs->add_line1).', '.ucwords($rs->add_line2).', '.ucwords($rs->panchayat).','.ucwords($rs->block).',  '.ucwords($gettehsil->tehsil_name).', '.ucwords($getdistrict->district_name).', '.ucwords($getstate->state_name).'</div></td></tr>';
